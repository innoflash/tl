...
!function () {
    ...
    window.Framework7 = function (a) {
        ...
        function n() {
            ...
            if (i || (i = 50), "string" == typeof i && i.indexOf("%") >= 0 && (i = parseInt(i, 10) / 100 * r), i > r && (i = r), l) t < i && a.trigger("infinite"); else if (t + r >= n - i) {
                if (s.length > 0 && (e = s.eq(-1)[0].f7VirtualList, e && !e.reachEnd && !e.params.updatableScroll)) return;
                a.trigger("infinite")
            }
        }
        ...
        var p = function (e, a) {
            ...
            i.params.pushState && s.main && (f ? u = f : m && u.indexOf(m) >= 0 && u.indexOf(m + "#") < 0 && (u = u.split(m)[0]));
            var h, g;
            ...
            var v, b, w, C, y, x, T, k, P, S, M, I = !1, E = !1, O = {}, z = [], D = [], L = !0, B = [], N = [];
            if (s.handleTouchStart = function (e) {
                    L && s.params.swipeBackPage && !I && !i.swipeoutOpenedEl && s.allowPageChange && (E = !1, I = !0, v = void 0, O.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, O.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, C = (new Date).getTime(), P = s.params.dynamicNavbar && l.find(".navbar-inner").length > 1)
                    ...
                    if (I) {
                        ...
                        if ("undefined" == typeof v && (v = !!(v || Math.abs(t - O.y) > Math.abs(a - O.x))), v || e.f7PreventSwipeBack || i.preventSwipeBack) return void(I = !1);
                        if (!E) {
                            var n = !1;
                            b = l.width();
                            var r = o(e.target), p = r.hasClass("swipeout") ? r : r.parents(".swipeout");
                            p.length > 0 && (!i.rtl && p.find(".swipeout-actions-left").length > 0 && (n = !0), i.rtl && p.find(".swipeout-actions-right").length > 0 && (n = !0)), z = r.is(".page") ? r : r.parents(".page"), z.hasClass("no-swipeback") && (n = !0), D = l.find(".page-on-left:not(.cached)");
                            var d = O.x - l.offset().left > s.params.swipeBackPageActiveArea;
                            if (d = i.rtl ? O.x < l.offset().left - l[0].scrollLeft + b - s.params.swipeBackPageActiveArea : O.x - l.offset().left > s.params.swipeBackPageActiveArea, d && (n = !0), 0 !== D.length && 0 !== z.length || (n = !0), n) return void(I = !1);
                            s.params.swipeBackPageAnimateShadow && !i.device.android && (S = z.find(".swipeback-page-shadow"), 0 === S.length && (S = o('<div class="swipeback-page-shadow"></div>'), z.append(S))), P && (B = l.find(".navbar-on-center:not(.cached)"), N = l.find(".navbar-on-left:not(.cached)"), y = B.find(".left, .center, .right, .subnavbar, .fading"), x = N.find(".left, .center, .right, .subnavbar, .fading"), i.params.animateNavBackIcon && (T = B.find(".left.sliding .back .icon"), k = N.find(".left.sliding .back .icon"))), o(".picker-modal.modal-in").length > 0 && i.closeModal(o(".picker-modal.modal-in"))
                        }
                        e.f7PreventPanelSwipe = !0, E = !0, e.preventDefault();
                        var c = i.rtl ? -1 : 1;
                        w = (a - O.x - s.params.swipeBackPageThreshold) * c, w < 0 && (w = 0);
                        var u = w / b, m = {
                            percentage: u,
                            activePage: z[0],
                            previousPage: D[0],
                        ...
                        s.params.onSwipeBackMove && s.params.onSwipeBackMove(m), l.trigger("swipeBackMove swipeback:move", m);
                        var f = w * c, h = (w / 5 - b / 5) * c;
                        if (1 === i.device.pixelRatio && (f = Math.round(f), h = Math.round(h)), z.transform("translate3d(" + f + "px,0,0)"), s.params.swipeBackPageAnimateShadow && !i.device.android && (S[0].style.opacity = 1 - 1 * u), D.transform("translate3d(" + h + "px,0,0)"), s.params.swipeBackPageAnimateOpacity && (D[0].style.opacity = .9 + .1 * u), P) {
                            var g;
                            ...
                            for (g = 0; g < x.length; g++) if (M = o(x[g]), M.is(".subnavbar.sliding") || (M[0].style.opacity = 1.3 * u - .3), M[0].className.indexOf("sliding") >= 0) {
                                ...
                                1 === i.device.pixelRatio && (L = Math.round(L)), M.transform("translate3d(" + L + "px,0,0)"), i.params.animateNavBackIcon && M[0].className.indexOf("left") >= 0 && k.length > 0 && k.transform("translate3d(" + -L + "px,0,0)")
                            }
                        }
                    }
                }, s.handleTouchEnd = function (e) {
                    if (!I || !E) return I = !1, void(E = !1);
                    if (I = !1, E = !1, 0 === w) return o([z[0], D[0]]).transform("").css({
                        opacity: "",
                        boxShadow: ""
                    ...
                    (a < 300 && w > 10 || a >= 300 && w > b / 2) && (z.removeClass("page-on-center").addClass("page-on-right"), D.removeClass("page-on-left").addClass("page-on-center"), P && (B.removeClass("navbar-on-center").addClass("navbar-on-right"), N.removeClass("navbar-on-left").addClass("navbar-on-center")), t = !0), o([z[0], D[0]]).transform("").css({
                        opacity: "",
                        boxShadow: ""
                    ...
                    }).addClass("page-transitioning")), L = !1, s.allowPageChange = !1;
                    var n = {activePage: z[0], previousPage: D[0], activeNavbar: B[0], previousNavbar: N[0]};
                    if (t) {
                        ...
                        s.url = r, i.pageBackCallback("before", s, {
                            ...
                            oldPage: z,
                            swipeBack: !0
                        }), s.params.onSwipeBackBeforeChange && s.params.onSwipeBackBeforeChange(n), l.trigger("swipeBackBeforeChange swipeback:beforechange", n)
                    } else s.params.onSwipeBackBeforeReset && s.params.onSwipeBackBeforeReset(n), l.trigger("swipeBackBeforeReset swipeback:beforereset", n);
                    z.transitionEnd(function () {
                        o([z[0], D[0]]).removeClass("page-transitioning"), P && (y.removeClass("page-transitioning").css({opacity: ""}), x.removeClass("page-transitioning").css({opacity: ""}), T && T.length > 0 && T.removeClass("page-transitioning"), k && k.length > 0 && k.removeClass("page-transitioning")), L = !0, s.allowPageChange = !0, t ? (i.params.pushState && s.main && history.back(), i.pageBackCallback("after", s, {
                            pageContainer: z[0],
                            url: r,
                            position: "center",
                            newPage: D,
                            ...
                            oldPage: z,
                            swipeBack: !0
                        }), i.router.afterBack(s, z, D), s.params.onSwipeBackAfterChange && s.params.onSwipeBackAfterChange(n), l.trigger("swipeBackAfterChange swipeback:afterchange", n)) : (s.params.onSwipeBackAfterReset && s.params.onSwipeBackAfterReset(n), l.trigger("swipeBackAfterReset swipeback:afterreset", n)), S && S.length > 0 && S.remove()
                    })
                }, s.attachEvents = function (e) {
                    var a = e ? "off" : "on",
                        t = !("touchstart" !== i.touchEvents.start || !i.support.passiveListener) && {
                            passive: !0,
                            capture: !1
                        }, n = !!i.support.passiveListener && {passive: !1, capture: !1};
                    l[a](i.touchEvents.start, s.handleTouchStart, t), l[a](i.touchEvents.move, s.handleTouchMove, n), l[a](i.touchEvents.end, s.handleTouchEnd, t)
                }, s.detachEvents = function () {
                    s.attachEvents(!0)
                }, s.params.swipeBackPage && !i.params.material && s.attachEvents(), s.params.name && (s.params.name = s.params.name.replace(/[^a-zA-Z]/g, "")), i.views.push(s), s.main ? (i.mainView = s, i.views.main = s) : s.params.name && (i[s.params.name + "View"] = s, i.views[s.params.name] = s), s.router = {
                    load: function (e) {
                ...
                }, s.loadPage = s.router.loadPage, s.loadContent = s.router.loadContent, s.reloadPage = s.router.reloadPage, s.reloadContent = s.router.reloadContent, s.reloadPreviousPage = s.router.reloadPreviousPage, s.reloadPreviousContent = s.router.reloadPreviousContent, s.refreshPage = s.router.refreshPage, s.refreshPreviousPage = s.router.refreshPreviousPage, s.back = s.router.back, s.hideNavbar = function (e) {
                ...
                var R = !i.params.pushStateNoAnimation && void 0, V = history.state;
            ...
            return s.destroy = function () {
                s.detachEvents(), s.main ? (i.mainView = null, delete i.mainView, i.views.main = null, delete i.views.main) : s.params.name && (i[s.params.name + "View"] = null, delete i[s.params.name + "View"], i.views[s.params.name] = null, delete i.views[s.params.name]), l.removeAttr("data-page"), l[0].f7View = null, delete l[0].f7View, i.views.splice(i.views.indexOf(s), 1);
                for (var e in s) s.hasOwnProperty(e) && (s[e] = null, delete s[e]);
                s = null
        ...
        i.addView = function (e, a) {
            ...
            if (!t && n && (t = o(n).parent(".navbar")[0]), n && (!n.f7NavbarInitialized || !e || e.params.domCache)) {
                var r = {container: t, innerContainer: n}, s = a && a.f7PageData, l = {page: s, navbar: r};
                if (n.f7NavbarInitialized && (e && e.params.domCache || !e && o(t).parents(".popup, .popover, .login-screen, .modal, .actions-modal, .picker-modal").length > 0)) return i.reinitNavbar(t, n), i.pluginHook("navbarReinit", l), void o(n).trigger("navbarReinit navbar:reinit", l);
                n.f7NavbarInitialized = !0, i.pluginHook("navbarBeforeInit", r, s), o(n).trigger("navbarBeforeInit navbar:beforeinit", l), i.initNavbar(t, n), i.pluginHook("navbarInit", r, s), o(n).trigger("navbarInit navbar:init", l)
            }
        }, i.navbarRemoveCallback = function (e, a, t, n) {
            !t && n && (t = o(n).parent(".navbar")[0]);
            var r, s = {container: t, innerContainer: n};
            a && (r = a.f7PageData);
            var l = {page: r, navbar: s};
            i.pluginHook("navbarBeforeRemove", s, r), o(n).trigger("navbarBeforeRemove navbar:beforeremove", l), s = null, r = null
            ...
            if (!i.params.material) {
                ...
                a.each(function () {
                    ...
                    if (!e.hasClass("cached")) {
                        ...
                        var C = t;
                        i.rtl && p && d && s.length > 0 && (C = -C), s.css({left: C + "px"})
                    }
                })
            }
        }, i.hideNavbar = function (e, a) {
            return "undefined" == typeof a && (a = !0), o(e).addClass("navbar-hidden" + (a ? "" : " not-animated")), !0
            ...
            return "undefined" == typeof a && (a = !0), o(e).addClass("toolbar-hidden" + (a ? "" : " not-animated")), !0
        ...
        var d = function (e, a) {
            ...
            s.setCancelButtonMargin = function () {
                ...
                s.input.val("").trigger("change"), s.container.removeClass("searchbar-active searchbar-not-empty"), s.cancelButton.length > 0 && !s.material && s.cancelButton.css(l, -s.cancelButton[0].offsetWidth + "px"), (s.searchList.length || s.params.customSearch) && s.overlay.removeClass("searchbar-overlay-active"), s.active = !1, i.device.ios ? setTimeout(function () {
                    e()
                }, 400) : e(), s.triggerEvent("disableSearch searchbar:disable", "onDisable")
            }, s.clear = function (e) {
                if (!s.query && e && o(e.target).hasClass("searchbar-clear")) return void s.disable();
                var a = s.value;
                s.input.val("").trigger("change").focus(), s.triggerEvent("clearSearch searchbar:clear", "onClear", {previousQuery: a})
            }, s.handleInput = function () {
                setTimeout(function () {
                    var e = s.input.val().trim();
                    (s.searchList.length > 0 || s.params.customSearch) && (s.params.searchIn || s.isVirtualList) && s.search(e, !0)
                }, 0)
            };
            var d, c = "";
            return s.search = function (e, a) {
                if (e.trim() !== c) {
                    ...
                    var t, n = [];
                    if (s.isVirtualList) {
                        if (d = s.searchList[0].f7VirtualList, "" === e.trim()) return d.resetFilter(), s.notFound.hide(), void s.found.show();
                        if (t = s.params.removeDiacritics ? o.removeDiacritics(e) : e, d.params.searchAll) n = d.params.searchAll(t, d.items) || []; else if (d.params.searchByItem) for (var r = 0; r < d.items.length; r++) d.params.searchByItem(t, r, d.params.items[r]) && n.push(r)
                    } else {
                        var i;
                        i = s.params.removeDiacritics ? o.removeDiacritics(e.trim().toLowerCase()).split(" ") : e.trim().toLowerCase().split(" "), s.searchList.find("li").removeClass("hidden-by-searchbar").each(function (e, a) {
                            a = o(a);
                            var t = [];
                            a.find(s.params.searchIn).each(function () {
                                var e = o(this).text().trim().toLowerCase();
                                s.params.removeDiacritics && (e = o.removeDiacritics(e)), t.push(e)
                            }), t = t.join(" ");
                            for (var r = 0, l = 0; l < i.length; l++) t.indexOf(i[l]) >= 0 && r++;
                            r === i.length || s.params.ignore && a.is(s.params.ignore) ? n.push(a[0]) : a.addClass("hidden-by-searchbar")
                        }), s.params.hideDividers && s.searchList.find(".item-divider, .list-group-title").each(function () {
                            ...
                            var i = s.params.ignore && e.is(s.params.ignore);
                            t && !i ? e.addClass("hidden-by-searchbar") : e.removeClass("hidden-by-searchbar")
                        }), s.params.hideGroups && s.searchList.find(".list-group").each(function () {
                            var e = o(this), a = s.params.ignore && e.is(s.params.ignore),
                    ...
                    s.triggerEvent("search searchbar:search", "onSearch", {
                        query: e,
                        foundItems: n
                    }), 0 === n.length ? (s.notFound.show(), s.found.hide()) : (s.notFound.hide(), s.found.show()), s.isVirtualList && d.filterItems(n)
                }
            }, s.attachEvents = function (e) {
                var a = e ? "off" : "on";
                s.container[a]("submit", t), s.material || s.cancelButton[a]("click", s.disable), s.overlay[a]("click", s.disable), s.input[a]("focus", s.enable), s.input[a]("change keydown keypress keyup", s.handleInput), s.clearButton[a]("click", s.clear)
            }, s.detachEvents = function () {
                s.attachEvents(!0)
            }, s.init = function () {
                s.attachEvents()
            ...
            }, s.init(), s.container[0].f7Searchbar = s, s
        };
        ...
        var c = function (e, a) {
            ...
            var i = this;
            if (i.params = a, i.container = o(e), 0 !== i.container.length) return i.textarea = i.params.textarea ? o(i.params.textarea) : i.container.find("textarea"), i.pageContainer = i.container.parents(".page").eq(0), i.pageContent = i.pageContainer.find(".page-content"), i.pageContentPadding = parseInt(i.pageContent.css("padding-bottom")), i.initialBarHeight = i.container[0].offsetHeight, i.initialAreaHeight = i.textarea[0].offsetHeight, i.sizeTextarea = function () {
            ...
            }, i.init(), i.container[0].f7Messagebar = i, i
        };
        i.messagebar = function (e, a) {
            ...
            return i.xhr = o.ajax({
                url: e, method: "GET", beforeSend: i.params.onAjaxStart, complete: function (e, a) {
                    "error" !== a && "timeout" !== a && e.status >= 200 && e.status < 300 || 0 === e.status ? (i.params.cache && "" !== e.responseText && (i.removeFromCache(r), i.cache.push({
                        url: r,
        ...
        i.triggerPageCallbacks = function (e, a, t) {
            ...
            if (a) {
                ...
                i.pluginHook("pageBeforeRemove", r), i.params.onPageBeforeRemove && i.params.onPageBeforeRemove(i, r), i.triggerPageCallbacks("beforeRemove", r.name, r), o(r.container).trigger("pageBeforeRemove page:beforeremove", {page: r}), r = null
            }
            ...
            if (r) {
                ...
                "after" === e && (i.pluginHook("pageAfterBack", s), i.params.onPageAfterBack && i.params.onPageAfterBack(i, s), i.triggerPageCallbacks("afterBack", s.name, s), o(r).trigger("pageAfterBack page:afterback", {page: s})), "before" === e && (i.pluginHook("pageBack", s), i.params.onPageBack && i.params.onPageBack(i, s), i.triggerPageCallbacks("back", s.name, s), o(s.container).trigger("pageBack page:back", {page: s}))
            }
            ...
            if (r) {
                ...
                if (r.f7PageData = l, "after" === e && (i.pluginHook("pageAfterAnimation", l), i.params.onPageAfterAnimation && i.params.onPageAfterAnimation(i, l), i.triggerPageCallbacks("afterAnimation", l.name, l), o(l.container).trigger("pageAfterAnimation page:afteranimation", {page: l})), "before" === e) {
            ...
            _remove: function (e) {
                i.params.routerRemoveTimeout || i.params.routerRemoveWithTimeout ? setTimeout(function () {
                    o(e).remove()
                }, 0) : o(e).remove()
            },
            ...
            findElement: function (e, a, t, n) {
                ...
                var r = a.find(e).filter(function (e, a) {
                    return 0 === o(a).parents(i.router._modalsSelector).length
                });
                return r.length > 1 && ("string" == typeof t.selector && (r = a.find(t.selector + " " + e)), r.length > 1 && (r = a.find("." + i.params.viewMainClass + " " + e))), 1 === r.length ? r : (n || (r = i.router.findElement(e, a, t, !0)), r && 1 === r.length ? r : r && r.length > 1 ? o(r[0]) : void 0)
            },
            ...
            prepareNavbar: function (e, a, t) {
                o(e).find(".sliding").each(function () {
                    var e = o(this), a = "right" === t ? this.f7NavbarRightOffset : this.f7NavbarLeftOffset;
            ...
            preroute: function (e, a, t) {
                return t && (a.isBack = !0), i.pluginHook("routerPreroute", e, a), !!(i.params.preroute && i.params.preroute(e, a) === !1 || e && e.params.preroute && e.params.preroute(e, a) === !1)
            },
            template7Render: function (e, a) {
                var t, n, r = a.url, s = a.content, p = a.content, d = a.context, c = a.contextName, u = a.template;
                if ("string" == typeof s ? r ? i.template7Cache[r] && !a.ignoreCache ? n = l.cache[r] : (n = l.compile(s), l.cache[r] = n) : n = l.compile(s) : u && (n = u), d) t = d, d && r && (e.contextCache[r] = d); else {
                    if (c) if (c.indexOf(".") >= 0) {
                    ...
                    !t && r && r in e.contextCache && (t = e.contextCache[r]), t || (t = {})
                }
                if (n && t) {
            ...
            var n, r, s, l, p, d, c, u, m, f = a.url, h = a.content, g = {content: a.content}, v = a.template,
                ...
                x = "undefined" == typeof f && h || v, T = a.pushState, k = a.pageElement;
            ...
            if (m = a.reload && (a.reloadPrevious ? "left" : "center"), n = b ? C.find('.page[data-page="' + b + '"]') : k ? o(k) : i.router.findElement(".page", i.router.temporaryDom, e), !n || 0 === n.length || b && e.activePage && e.activePage.name === b) return void(e.allowPageChange = !0);
            if (n.addClass(a.reload ? "page-on-" + m : "page-on-right"), s = C.children(".page:not(.cached)"), k && (s = s.filter(function (e, a) {
                    if (a !== k) return a
                })), a.reload && a.reloadPrevious && 1 === s.length) return void(e.allowPageChange = !0);
            if (a.reload) r = s.eq(s.length - 1); else {
                if (s.length > 1) {
                    for (l = 0; l < s.length - 2; l++) e.params.domCache ? o(s[l]).addClass("cached") : (i.pageRemoveCallback(e, s[l], "left"), i.router._remove(s[l]));
                    e.params.domCache ? o(s[l]).addClass("cached") : (i.pageRemoveCallback(e, s[l], "left"), i.router._remove(s[l]))
                }
                r = C.children(".page:not(.cached)")
            }
            if (k && r.length > 1 && (r = r.filter(function (e, a) {
                    if (a !== k) return a
                })), (e.params.domCache || k) && n.removeClass("cached"), e.params.dynamicNavbar) if (u = !0, d = b ? w.find('.navbar-inner[data-page="' + b + '"]') : i.router.findElement(".navbar-inner", i.router.temporaryDom, e), d && 0 !== d.length || (d = n.find(".navbar-inner"), d && 0 !== d.length ? d.parent(".navbar").length > 0 && d.prependTo(n) : u = !1), u && n.find(".navbar").length > 0 && i.router._remove(n.find(".navbar").filter(function (e, a) {
                    return 0 === o(a).parents(i.router._modalsSelector).length
                ...
                for (l = 0; l < p.length - 1; l++) e.params.domCache ? o(p[l]).addClass("cached") : (i.navbarRemoveCallback(e, s[l], c[0], p[l]), i.router._remove(p[l]));
                d || 1 !== p.length || (e.params.domCache ? o(p[0]).addClass("cached") : (i.navbarRemoveCallback(e, s[0], c[0], p[0]), i.router._remove(p[0]))), p = c.find(".navbar-inner:not(.cached)")
            }
            if (u && (d.addClass(a.reload ? "navbar-on-" + m : "navbar-on-right"), (e.params.domCache || k) && d.removeClass("cached"), n[0].f7RelatedNavbar = d[0], d[0].f7RelatedPage = n[0]), f) f && k && (e.pageElementsCache[f] = {
                page: n,
                navbarInner: d
            }); else {
            ...
            if (i.params.pushState && !a.reloadPrevious && e.main) {
                ...
                var M = i.params.pushStateRoot || "", I = a.reload ? "replaceState" : "pushState";
                T && (x || b ? x && h ? history[I]({
                    content: "string" == typeof h ? h : "",
                    url: f,
                    viewIndex: i.views.indexOf(e)
                }, "", M + i.params.pushStateSeparator + f) : b && history[I]({
                    pageName: b,
                    url: f,
                    viewIndex: i.views.indexOf(e)
                }, "", M + i.params.pushStateSeparator + f) : history[I]({
                    url: f,
                    viewIndex: i.views.indexOf(e)
            ...
            if (e.url = f, a.reload) {
                ...
                E && 0 === E.indexOf("#") && E in e.contentCache && E !== f && e.history.indexOf(E) === -1 ? (e.contentCache[E] = null, delete e.contentCache[E]) : E && E in e.pageElementsCache && E !== f && (e.history.indexOf(E) === -1 || e.history.indexOf(E) === e.history.length - 1) && (e.pageElementsCache[E] = null, delete e.pageElementsCache[E]), E && E in e.contextCache && E !== f && (e.history.indexOf(E) === -1 || e.history.indexOf(E) === e.history.length - 1) && (e.contextCache[E] = null, delete e.contextCache[E]), e.history[e.history.length - (a.reloadPrevious ? 2 : 1)] = f
            } else e.history.push(f);
            var O = !1;
            if (e.params.uniqueHistory) {
                var z = e.history, D = f;
                if (e.params.uniqueHistoryIgnoreGetParameters) for (z = [], D = f.split("?")[0], l = 0; l < e.history.length; l++) z.push(e.history[l].split("?")[0]);
                z.indexOf(D) !== z.lastIndexOf(D) && (e.history = e.history.slice(0, z.indexOf(D)), e.history.push(f), O = !0)
            }
            if (a.reloadPrevious ? (r = r.prev(".page"), n.insertBefore(r), u && (p = p.prev(".navbar-inner"), d.insertAfter(p))) : (C.append(n[0]), u && c.append(d[0])), a.reload && (e.params.domCache && e.initialPages.indexOf(r[0]) >= 0 ? (r.addClass("cached"), u && p.addClass("cached")) : (i.pageRemoveCallback(e, r[0], m), u && i.navbarRemoveCallback(e, r[0], c[0], p[0]), i.router._remove(r), u && i.router._remove(p))), i.pageInitCallback(e, {
                    pageContainer: n[0],
                    url: f,
            ...
            var n = a.url, r = a.content, s = a.pageName, l = a.pageElement;
            s && s.indexOf("?") > 0 && (a.query = o.parseUrlQuery(s), a.pageName = s = s.split("?")[0]);
            var p = a.template;
            return e.params.reloadPages === !0 && (a.reload = !0), !!e.allowPageChange && (!(n && e.url === n && !a.reload && !e.params.allowDuplicateUrls) && (e.allowPageChange = !1, i.xhr && e.xhr && e.xhr === i.xhr && (i.xhr.abort(), i.xhr = !1), r || s || l ? void t(r) : p ? void i.router._load(e, a) : a.url && "#" !== a.url ? void i.get(a.url, e, a.ignoreCache, function (a, n) {
            ...
            function r() {
                ...
                p = k ? o(k) : i.router.findElement(".page", i.router.temporaryDom, e), e.params.dynamicNavbar && (c = i.router.findElement(".navbar-inner", i.router.temporaryDom, e))
            }

            function s() {
                if (!p || 0 === p.length) return void(e.allowPageChange = !0);
                if (e.params.dynamicNavbar && "undefined" == typeof f && (f = !(!c || 0 === c.length)), p.addClass("page-on-left").removeClass("cached"), f && (u = P.children(".navbar"), m = u.find(".navbar-inner:not(.cached)"), c.addClass("navbar-on-left").removeClass("cached")), x) {
                    var t, r;
                    if (t = o(M[M.length - 2]), f && (r = o(t[0] && t[0].f7RelatedNavbar || m[m.length - 2])), e.params.domCache && e.initialPages.indexOf(t[0]) >= 0) t.length && t[0] !== p[0] && t.addClass("cached"), f && r.length && r[0] !== c[0] && r.addClass("cached"); else {
                        var s = f && r.length;
                        t.length ? (i.pageRemoveCallback(e, t[0], "right"), s && i.navbarRemoveCallback(e, t[0], u[0], r[0]), i.router._remove(t), s && i.router._remove(r)) : s && (i.navbarRemoveCallback(e, t[0], u[0], r[0]), i.router._remove(r))
                    }
                    M = S.children(".page:not(.cached)"), f && (m = P.children(".navbar").find(".navbar-inner:not(.cached)")), e.history.indexOf(h) >= 0 ? e.history = e.history.slice(0, e.history.indexOf(h) + 2) : e.history[[e.history.length - 2]] ? e.history[e.history.length - 2] = h : e.history.unshift(h)
                }
                if (l = o(M[M.length - 1]), e.params.domCache && l[0] === p[0] && (l = S.children(".page.page-on-center"), 0 === l.length && e.activePage && (l = o(e.activePage.container))), f && !d && (d = o(m[m.length - 1]), e.params.domCache && (d[0] === c[0] && (d = u.children(".navbar-inner.navbar-on-center:not(.cached)")), 0 === d.length && (d = u.children('.navbar-inner[data-page="' + l.attr("data-page") + '"]'))), 0 !== d.length && c[0] !== d[0] || (f = !1)), f && (I && c.insertBefore(d), c[0].f7RelatedPage = p[0], p[0].f7RelatedNavbar = c[0]), I && p.insertBefore(l), i.pageInitCallback(e, {
                        pageContainer: p[0],
                        url: h,
                        position: "left",
            ...
            if (p) {
                ...
                if (n && n in e.pageElementsCache) t(); else if (0 !== n.indexOf("#")) return void i.get(a.url, e, a.ignoreCache, function (a, n) {
                    return n ? void(e.allowPageChange = !0) : void t(a)
                })
            }
            e.allowPageChange = !0
        }, i.router.afterBack = function (e, a, t) {
            a = o(a), t = o(t), e.params.domCache && e.initialPages.indexOf(a[0]) >= 0 ? a.removeClass("page-from-center-to-right").addClass("cached") : (i.pageRemoveCallback(e, a[0], "right"), i.router._remove(a)), t.removeClass("page-from-left-to-center page-on-left").addClass("page-on-center"), e.allowPageChange = !0;
            var n, r = e.history.pop();
            if (e.params.dynamicNavbar) {
                var s = o(e.container).children(".navbar").find(".navbar-inner:not(.cached)"),
                    l = o(a[0].f7RelatedNavbar || s[1]);
                e.params.domCache && e.initialNavbars.indexOf(l[0]) >= 0 ? l.removeClass("navbar-from-center-to-right").addClass("cached") : (i.navbarRemoveCallback(e, a[0], void 0, l[0]), i.router._remove(l)), n = o(s[0]).removeClass("navbar-on-left navbar-from-left-to-center").addClass("navbar-on-center")
            }
            if (e.params.domCache && o(e.container).find(".page.cached").each(function () {
                    var a = o(this), t = a[0].f7PageData && a[0].f7PageData.url;
                    t && e.history.indexOf(t) < 0 && e.initialPages.indexOf(this) < 0 && (i.pageRemoveCallback(e, a[0], "right"), a[0].f7RelatedNavbar && e.params.dynamicNavbar && i.navbarRemoveCallback(e, a[0], void 0, a[0].f7RelatedNavbar), i.router._remove(a), a[0].f7RelatedNavbar && e.params.dynamicNavbar && i.router._remove(a[0].f7RelatedNavbar))
                }), !e.params.domCache && r && r.indexOf("#") > -1 && r in e.contentCache && e.history.indexOf(r) === -1 && (e.contentCache[r] = null, delete e.contentCache[r]), r && r in e.pageElementsCache && e.history.indexOf(r) === -1 && (e.pageElementsCache[r] = null, delete e.pageElementsCache[r]), r && r in e.contextCache && e.history.indexOf(r) === -1 && (e.contextCache[r] = null, delete e.contextCache[r]), i.params.pushState && e.main && i.pushStateClearQueue(), e.params.preloadPreviousPage) if (e.params.domCache && e.history.length > 1) {
        ...
        i.modalStack = [], i.modalStackClearQueue = function () {
            ...
            f.innerHTML = a;
            var m = o(f).children();
            return i.root.append(m[0]), m.find(".modal-button").each(function (a, t) {
            ...
            i.closeModal(".modal-preloader")
        }, i.showIndicator = function () {
            o(".preloader-indicator-overlay").length > 0 || i.root.append('<div class="preloader-indicator-overlay"></div><div class="preloader-indicator-modal"><span class="preloader preloader-white">' + (i.params.material ? i.params.materialPreloaderHtml : "") + "</span></div>")
        }, i.hideIndicator = function () {
            o(".preloader-indicator-overlay, .preloader-indicator-modal").remove()
        }, i.actions = function (e, a, t) {
            var n, r, s, p = !1;
            1 === arguments.length || 2 === arguments.length && "boolean" == typeof arguments[1] ? (a = arguments[0], t = arguments[1]) : i.device.ios ? i.device.ipad && (p = !0) : i.width >= 768 && (p = !0), "undefined" == typeof t && (t = !0), a = a || [], a.length > 0 && !Array.isArray(a[0]) && (a = [a]);
            var d;
            if (p) {
                var c = i.params.modalActionsToPopoverTemplate || '<div class="popover actions-popover"><div class="popover-inner">{{#each this}}<div class="list-block"><ul>{{#each this}}{{#if label}}<li class="actions-popover-label {{#if color}}color-{{color}}{{/if}} {{#if bold}}actions-popover-bold{{/if}}">{{text}}</li>{{else}}<li><a href="#" class="item-link list-button {{#if color}}color-{{color}}{{/if}} {{#if bg}}bg-{{bg}}{{/if}} {{#if bold}}actions-popover-bold{{/if}} {{#if disabled}}disabled{{/if}}">{{text}}</a></li>{{/if}}{{/each}}</ul></div>{{/each}}</div></div>';
                i._compiledTemplates.actionsToPopover || (i._compiledTemplates.actionsToPopover = l.compile(c));
                var u = i._compiledTemplates.actionsToPopover(a);
                n = o(i.popover(u, e, !0, t)), r = ".list-block ul", s = ".list-button"
            } else {
                if (i.params.modalActionsTemplate) i._compiledTemplates.actions || (i._compiledTemplates.actions = l.compile(i.params.modalActionsTemplate)), d = i._compiledTemplates.actions(a); else {
                    for (var m = "", h = 0; h < a.length; h++) for (var g = 0; g < a[h].length; g++) {
                        0 === g && (m += '<div class="actions-modal-group">');
                        var v = a[h][g], b = v.label ? "actions-modal-label" : "actions-modal-button";
                        v.bold && (b += " actions-modal-button-bold"), v.color && (b += " color-" + v.color), v.bg && (b += " bg-" + v.bg), v.disabled && (b += " disabled"), m += '<div class="' + b + '">' + v.text + "</div>", g === a[h].length - 1 && (m += "</div>")
                    }
                    d = '<div class="actions-modal">' + m + "</div>"
                }
                f.innerHTML = d, n = o(f).children(), i.root.append(n[0]), r = ".actions-modal-group", s = ".actions-modal-button"
            }
            var w = n.find(r);
            return w.each(function (e, t) {
                var r = e;
                o(t).children().each(function (e, t) {
                    var l, d = e, c = a[r][d];
                    !p && o(t).is(s) && (l = o(t)), p && o(t).find(s).length > 0 && (l = o(t).find(s)), l && l.on("click", function (e) {
                        c.close !== !1 && i.closeModal(n), c.onClick && c.onClick(n, e)
                    })
                })
            }), p || i.openModal(n, t), n[0]
        }, i.popover = function (e, a, t, n, r) {
            function s() {
                e.css({left: "", top: ""});
                var t, n, r, s = e.width(), o = e.height(), l = 0;
                ...
                var d = a.outerWidth(), c = a.outerHeight(), u = a.offset(), m = u.left - i.left, f = u.top - i.top,
                    h = a.parents(".page");
                h.length > 0 && (f -= h[0].scrollTop);
                var g = 0, v = 0, b = 0, w = p ? "bottom" : "top";
                if (p) if (o < i.height - f - c ? (w = "bottom", g = f) : o < f ? (g = f - o + c, w = "top") : (w = "bottom", g = f), g <= 0 ? g = 8 : g + o >= i.height && (g = i.height - o - 8), v = m, v + s >= i.width - 8 && (v = m + d - s - 8), v < 8 && (v = 8), "top" === w && e.addClass("popover-on-top"), "bottom" === w && e.addClass("popover-on-bottom"), a.hasClass("floating-button-to-popover") && !e.hasClass("modal-in")) {
                    e.addClass("popover-floating-button");
                    var C = v + s / 2 - (m + d / 2), y = g + o / 2 - (f + c / 2);
                ...
                } else a.hasClass("floating-button-to-popover") && e.hasClass("modal-in") && (v = m, g = f); else o + l < f ? g = f - o - l : o + l < i.height - f - c ? (w = "bottom", g = f + c + l) : (w = "middle", g = c / 2 + f - o / 2, b = g, g <= 0 ? g = 5 : g + o >= i.height && (g = i.height - o - 5), b -= g), "top" === w || "bottom" === w ? (v = d / 2 + m - s / 2, b = v, v < 5 && (v = 5), v + s > i.width && (v = i.width - s - 5), "top" === w && t.addClass("on-bottom"), "bottom" === w && t.addClass("on-top"), b -= v, n = s / 2 - l + b, n = Math.max(Math.min(n, s - 2 * l - 13), 13), t.css({left: n + "px"})) : "middle" === w && (v = m - s - l, t.addClass("on-right"), (v < 5 || v + s > i.width) && (v < 5 && (v = m + d + l), v + s > i.width && (v = i.width - s - 5), t.removeClass("on-right").addClass("on-left")), r = o / 2 - l + b, r = Math.max(Math.min(r, o - 2 * l - 13), 13), t.css({top: r + "px"}));
                e.css({top: g + "px", left: v + "px"})
            }

            if ("undefined" == typeof t && (t = !0), "undefined" == typeof r && (r = !0), "undefined" == typeof n && (n = !0), "string" == typeof e && e.indexOf("<") >= 0) {
                var l = document.createElement("div");
                if (l.innerHTML = e.trim(), !(l.childNodes.length > 0)) return !1;
                e = l.childNodes[0], t && e.classList.add("remove-on-close"), r || e.classList.add("ignore-close-by-outside"), i.root.append(e)
            }
            if (e = o(e), a = o(a), 0 === e.length || 0 === a.length) return !1;
            0 === e.parents("body").length && (t && e.addClass("remove-on-close"), r || e.addClass.add("ignore-close-by-outside"), i.root.append(e[0])), 0 !== e.find(".popover-angle").length || i.params.material || e.append('<div class="popover-angle"></div>'), e.show();
            var p = i.params.material;
            return s(), i.onResize(s), e.on("popover:close", function () {
                i.offResize(s)
            }), i.openModal(e, n), e[0]
        }, i.popup = function (e, a, t) {
            if ("undefined" == typeof a && (a = !0), "undefined" == typeof t && (t = !0), "string" == typeof e && e.indexOf("<") >= 0) {
                var n = document.createElement("div");
                if (n.innerHTML = e.trim(), !(n.childNodes.length > 0)) return !1;
                e = n.childNodes[0], a && e.classList.add("remove-on-close"), i.root.append(e)
            }
            return e = o(e), 0 !== e.length && (0 === e.parents("body").length && (a && e.addClass("remove-on-close"), i.root.append(e[0])), e.show(), i.openModal(e, t), e[0])
        }, i.pickerModal = function (e, a, t) {
            if ("undefined" == typeof a && (a = !0), "undefined" == typeof t && (t = !0), "string" == typeof e && e.indexOf("<") >= 0) {
                if (e = o(e), !(e.length > 0)) return !1;
                a && e.addClass("remove-on-close"), i.root.append(e[0])
            }
            return e = o(e), 0 !== e.length && (0 === e.parents("body").length && (a && e.addClass("remove-on-close"), i.root.append(e[0])), o(".picker-modal.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && i.closeModal(".picker-modal.modal-in:not(.modal-out)"), e.show(), i.openModal(e, t), e[0])
        }, i.loginScreen = function (e, a) {
            return e || (e = ".login-screen"), "undefined" == typeof a && (a = !0), e = o(e), 0 !== e.length && (o(".login-screen.modal-in:not(.modal-out)").length > 0 && !e.hasClass("modal-in") && i.closeModal(".login-screen.modal-in:not(.modal-out)"), e.show(), i.openModal(e, a), e[0])
        }, i.openModal = function (e, a) {
            "undefined" == typeof a && (a = !0), e = o(e), e[a ? "removeClass" : "addClass"]("not-animated");
            var t = e.hasClass("modal"), n = e.hasClass("popover"), r = e.hasClass("popup"),
                s = e.hasClass("login-screen"), l = e.hasClass("picker-modal"), p = e.hasClass("actions-modal"),
                d = "modal";
            if (n && (d = "popover"), r && (d = "popup"), s && (d = "loginscreen"), l && (d = "picker"), p && (d = "actions"), o(".modal.modal-in:not(.modal-out)").length && i.params.modalStack && t) return void i.modalStack.push(function () {
                i.openModal(e)
            });
            if (!0 !== e.data("f7-modal-shown")) {
                e.data("f7-modal-shown", !0);
                var c = e.parent();
                i.params.modalsMoveToRoot && !c.is(i.root) && (i.root.append(e), e.once(d + ":closed", function () {
                    c.append(e)
                })), e.once(d + ":close", function () {
                    e.removeData("f7-modal-shown")
                }), t && (e.show(), e.css({marginTop: -Math.round(e.outerHeight() / 2) + "px"}));
                var u;
                s || l || (0 !== o(".modal-overlay").length || r || i.root.append('<div class="modal-overlay"></div>'), 0 === o(".popup-overlay").length && r && i.root.append('<div class="popup-overlay"></div>'), u = o(r ? ".popup-overlay" : ".modal-overlay")), i.params.material && l && e.hasClass("picker-calendar") && (0 !== o(".picker-modal-overlay").length || r || i.root.append('<div class="picker-modal-overlay"></div>'), u = o(".picker-modal-overlay")), u && u[a ? "removeClass" : "addClass"]("not-animated");
                e[0].clientLeft;
                return e.trigger("open " + d + ":open"), l && o("body").addClass("with-picker-modal"), e.find("." + i.params.viewClass).length > 0 && (e.find(".page").each(function () {
                    i.initPageWithCallback(this)
                }), e.find(".navbar").each(function () {
                    i.initNavbarWithCallback(this)
                })), s || l || u.addClass("modal-overlay-visible"), i.params.material && l && u && u.addClass("modal-overlay-visible"), a ? e.removeClass("modal-out").addClass("modal-in").transitionEnd(function (a) {
            ...
            if ("undefined" == typeof a && (a = !0), e = o(e || ".modal-in"), "undefined" == typeof e || 0 !== e.length) {
                e[a ? "removeClass" : "addClass"]("not-animated");
                var t = e.hasClass("modal"), n = e.hasClass("popover"), r = e.hasClass("popup"),
                    s = e.hasClass("login-screen"), l = e.hasClass("picker-modal"), p = e.hasClass("actions-modal"),
                    d = "modal";
                n && (d = "popover"), r && (d = "popup"), s && (d = "loginscreen"), l && (d = "picker"), p && (d = "actions");
                var c = e.hasClass("remove-on-close");
                if (!n || !e.hasClass("ignore-close-by-outside")) {
                    var u, m = e.hasClass("keep-on-close");
                    return r ? u = o(".popup-overlay") : l && i.params.material ? u = o(".picker-modal-overlay") : l || (u = o(".modal-overlay")), r ? e.length === o(".popup.modal-in").length && u.removeClass("modal-overlay-visible") : u && u.length > 0 && u.removeClass("modal-overlay-visible"), u && u[a ? "removeClass" : "addClass"]("not-animated"), e.trigger("close " + d + ":close"), l && (o("body").removeClass("with-picker-modal"), o("body").addClass("picker-modal-closing")), !n || i.params.material ? (a ? e.removeClass("modal-in").addClass("modal-out").transitionEnd(function (a) {
                        if (e.hasClass("modal-out")) e.trigger("closed " + d + ":closed"); else if (e.trigger("opened " + d + ":opened"), n) return;
                        l && o("body").removeClass("picker-modal-closing"), r || s || l || n ? (e.removeClass("modal-out").hide(), c && e.length > 0 && e.remove()) : m || e.remove()
                    }) : (e.trigger("closed " + d + ":closed"), e.removeClass("modal-in modal-out"), l && o("body").removeClass("picker-modal-closing"), r || s || l || n ? (e.hide(), c && e.length > 0 && e.remove()) : m || e.remove()), t && i.params.modalStack && i.modalStackClearQueue()) : (e.removeClass("modal-in modal-out not-animated").trigger("closed " + d + ":closed").hide(), c && e.remove()), !0
                }
            }
            ...
            if ("number" == typeof e && (e = i.root, a = arguments[0], t = arguments[1]), a && "string" == typeof a && parseFloat(a) !== 1 * a && (t = a, a = void 0), e = o(e || i.root), 0 !== e.length) {
                var n;
        ...
        }, i.allowPanelOpen = !0, i.openPanel = function (e, a) {
            function t() {
                l.transitionEnd(function (e) {
                    o(e.target).is(l) ? (n.hasClass("active") ? n.trigger("opened panel:opened") : n.trigger("closed panel:closed"), s.css({display: ""}), i.allowPanelOpen = !0) : t()
                })
            }

            if ("undefined" == typeof a && (a = !0), !i.allowPanelOpen) return !1;
            var n = o(".panel-" + e);
            ...
            var s = o(".panel-overlay");
            s[a ? "removeClass" : "addClass"]("not-animated"), s.show(), n.find("." + i.params.viewClass).length > 0 && i.sizeNavbars && i.sizeNavbars(n.find("." + i.params.viewClass)[0]);
            var l = (n[0].clientLeft, "reveal" === r ? o("." + i.params.viewsClass) : n);
            return a ? t() : (n.trigger("opened panel:opened"), s.css({display: ""}), i.allowPanelOpen = !0), o("body").addClass("with-panel-" + e + "-" + r), !0
            ...
            a[e ? "removeClass" : "addClass"]("not-animated"), a.removeClass("active");
            var r = o(".panel-overlay");
            r.removeClass("not-animated");
            var s = "reveal" === t ? o("." + i.params.viewsClass) : a;
            a.trigger("close panel:close"), i.allowPanelOpen = !1, e ? (s.transitionEnd(function () {
                a.hasClass("active") || (a.css({display: ""}), a.trigger("closed panel:closed"), o("body").removeClass("panel-closing"), i.allowPanelOpen = !0)
            }), o("body").addClass("panel-closing").removeClass("with-panel-" + n + "-" + t)) : (a.css({display: ""}), a.trigger("closed panel:closed"), a.removeClass("not-animated"), o("body").removeClass("with-panel-" + n + "-" + t), i.allowPanelOpen = !0)
        }, i.initPanelsBreakpoints = function () {
            function e() {
                i.params.panelLeftBreakpoint && t.length > 0 && (a = t.hasClass("panel-visible-by-breakpoint"), i.width >= i.params.panelLeftBreakpoint ? a || (o("body").removeClass("with-panel-left-reveal with-panel-left-cover"), t.css("display", "").addClass("panel-visible-by-breakpoint").removeClass("active"), t.trigger("open panel:open opened panel:opened"), r.css({"margin-left": t.width() + "px"}), i.allowPanelOpen = !0) : a && (t.css("display", "").removeClass("panel-visible-by-breakpoint active"), t.trigger("close panel:close closed panel:closed"), r.css({"margin-left": ""}), i.allowPanelOpen = !0)), i.params.panelRightBreakpoint && n.length > 0 && (a = n.hasClass("panel-visible-by-breakpoint"), i.width >= i.params.panelRightBreakpoint ? a || (o("body").removeClass("with-panel-right-reveal with-panel-right-cover"), n.css("display", "").addClass("panel-visible-by-breakpoint").removeClass("active"), n.trigger("open panel:open opened panel:opened"), r.css({"margin-right": n.width() + "px"}), i.allowPanelOpen = !0) : a && (n.css("display", "").removeClass("panel-visible-by-breakpoint active"), n.trigger("close panel:close closed panel:closed"), r.css({"margin-right": ""}), i.allowPanelOpen = !0))
            }

            var a, t = o(".panel-left"), n = o(".panel-right"), r = i.root.children(".views");
            i.onResize(e), e()
        }, i.initSwipePanels = function () {
            function e(e) {
                if (i.allowPanelOpen && (i.params.swipePanel || i.params.swipePanelOnlyClose) && !s && !(o(".modal-in, .photo-browser-in").length > 0) && (i.params.swipePanelCloseOpposite || i.params.swipePanelOnlyClose || !(o(".panel.active").length > 0) || n.hasClass("active")) && !(e.target && "input" === e.target.nodeName.toLowerCase() && "range" === e.target.type || o(e.target).closest(".tabs-swipeable-wrap").length > 0)) {
                    ...
                    if (n = o(".panel.panel-" + r), f = n.hasClass("active"), i.params.swipePanelActiveArea && !f) {
                        ...
                        if ("right" === r && w.x < i.width - i.params.swipePanelActiveArea) return
                    }
            ...
            function a(e) {
                if (s && !e.f7PreventPanelSwipe) {
                    ...
                    if (!v) {
                        if (v = a > w.x ? "to-right" : "to-left", "both" === r) {
                            if (r = o(".panel.active").length > 0 ? o(".panel.active").hasClass("panel-left") ? "left" : "right" : "to-right" === v ? "left" : "right", i.params.swipePanelActiveArea > 0) {
                                if ("left" === r && w.x > i.params.swipePanelActiveArea) return void(s = !1);
                                if ("right" === r && w.x < i.width - i.params.swipePanelActiveArea) return void(s = !1)
                            }
                            n = o(".panel.panel-" + r)
                        }
                        if (n.hasClass("panel-visible-by-breakpoint")) return void(s = !1);
                        if ("left" === r && "to-left" === v && !n.hasClass("active") || "right" === r && "to-right" === v && !n.hasClass("active")) return void(s = !1)
                    }
                    if (i.params.swipePanelNoFollow) {
                        var y = (new Date).getTime() - d;
                        return y < 300 && ("to-left" === v && ("right" === r && i.openPanel(r), "left" === r && n.hasClass("active") && i.closePanel()), "to-right" === v && ("left" === r && i.openPanel(r), "right" === r && n.hasClass("active") && i.closePanel())), s = !1, void(l = !1)
                    }
                    ...
                    "right" === r && (x = -x), c = a - w.x + x, "right" === r ? "cover" === g ? (u = c + (f ? 0 : h), u < 0 && (u = 0), u > h && (u = h)) : (u = c - (f ? h : 0), u > 0 && (u = 0), u < -h && (u = -h)) : (u = c + (f ? h : 0), u < 0 && (u = 0), u > h && (u = h)), "reveal" === g ? (C.transform("translate3d(" + u + "px,0,0)").transition(0), b.transform("translate3d(" + u + "px,0,0)").transition(0), n.trigger("panel:swipe", {progress: Math.abs(u / h)}), i.pluginHook("swipePanelSetTransform", C[0], n[0], Math.abs(u / h))) : ("left" === r && (u -= h), n.transform("translate3d(" + u + "px,0,0)").transition(0), b.transition(0), m = 1 - Math.abs(u / h), b.css({opacity: m}), n.trigger("panel:swipe", {progress: Math.abs(u / h)}), i.pluginHook("swipePanelSetTransform", C[0], n[0], Math.abs(u / h)))
                }
            }
            ...
            function t(e) {
                ...
                if (a = f ? "cover" === g ? 0 === u ? "reset" : t < 300 && Math.abs(u) > 0 ? "swap" : t >= 300 && Math.abs(u) < h / 2 ? "reset" : "swap" : u === -h ? "reset" : t < 300 && Math.abs(u) >= 0 || t >= 300 && Math.abs(u) <= h / 2 ? "left" === r && u === h ? "reset" : "swap" : "reset" : "cover" === g ? 0 === u ? "swap" : t < 300 && Math.abs(u) > 0 ? "swap" : t >= 300 && Math.abs(u) < h / 2 ? "swap" : "reset" : 0 === u ? "reset" : t < 300 && Math.abs(u) > 0 || t >= 300 && Math.abs(u) >= h / 2 ? "swap" : "reset", "swap" === a && (i.allowPanelOpen = !0, f ? (i.closePanel(), p && (n.css({display: ""}), o("body").removeClass("panel-closing"))) : i.openPanel(r), p && (i.allowPanelOpen = !0)), "reset" === a) if (f) i.allowPanelOpen = !0, i.openPanel(r); else if (i.closePanel(), p) i.allowPanelOpen = !0, n.css({display: ""}); else {
                    var c = "reveal" === g ? C : n;
                    n.trigger("close panel:close"), o("body").addClass("panel-closing"), c.transitionEnd(function () {
                        n.hasClass("active") || (n.trigger("close panel:closed"), n.css({display: ""}), o("body").removeClass("panel-closing"), i.allowPanelOpen = !0)
                    })
                }
            ...
            if (i.params.swipePanel) {
                if (n = o(".panel.panel-" + i.params.swipePanel), r = i.params.swipePanel, 0 === n.length && "both" !== r) return
            } else {
                if (!i.params.swipePanelOnlyClose) return;
                if (0 === o(".panel").length) return
            }
            var s, l, p, d, c, u, m, f, h, g, v, b = o(".panel-overlay"), w = {}, C = o("." + i.params.viewsClass),
                y = !("touchstart" !== i.touchEvents.start || !i.support.passiveListener) && {passive: !0, capture: !1},
                x = !!i.support.passiveListener && {passive: !1, capture: !1};
            o(document).on(i.touchEvents.start, e, y), o(document).on(i.touchEvents.move, a, x), o(document).on(i.touchEvents.end, t, y)
        }, i.initImagesLazyLoad = function (e) {
            function a(e) {
                function t() {
                    e.removeClass("lazy").addClass("lazy-loaded"), r ? e.css("background-image", "url(" + s + ")") : e.attr("src", s), i.params.imagesLazyLoadSequential && (u = !1, c.length > 0 && a(c.shift())), e.trigger("lazy-loaded"), i.params.onLazyLoaded && i.params.onLazyLoaded(e)
                }

                function n() {
                    e.removeClass("lazy").addClass("lazy-loaded"), r ? e.css("background-image", "url(" + d + ")") : e.attr("src", d), i.params.imagesLazyLoadSequential && (u = !1, c.length > 0 && a(c.shift())), e.trigger("lazy-error"), i.params.onLazyError && i.params.onLazyError(e)
                }

                e = o(e);
                var r = e.attr("data-background"), s = r ? r : e.attr("data-src");
                if (s) {
                    if (i.params.imagesLazyLoadSequential && u) return void(c.indexOf(e[0]) < 0 && c.push(e[0]));
                    u = !0;
                    var l = new Image;
                    l.onload = t, l.onerror = n, l.src = s, e.trigger("lazy-load"), i.params.onLazyLoad && !e.hasClass("lazy-loaded") && i.params.onLazyLoad(e)
                }
            }
            ...
            function n(e) {
                ...
                return a.top >= 0 - t && a.left >= 0 - t && a.top <= i.height + t && a.left <= i.width + t
            }

            function r(a) {
                var n = a ? "off" : "on";
                l[n]("lazy", t), l.parents(".tab")[n]("show", t), e[n]("lazy", t), p[n]("lazy", t), p[n]("scroll", t), i["on" === n ? "onResize" : "offResize"](t)
            }
            ...
            if (e.hasClass("lazy") ? (l = e, e = l.parents(".page")) : l = e.find(".lazy"), 0 !== l.length) {
                ...
                if (e.hasClass("page-content") ? (p = e, e = e.parents(".page")) : p = e.find(".page-content"), 0 !== p.length) {
                    ...
                    "string" == typeof i.params.imagesLazyLoadPlaceholder && (d = i.params.imagesLazyLoadPlaceholder), i.params.imagesLazyLoadPlaceholder !== !1 && l.each(function () {
                        o(this).attr("data-src") && !o(this).attr("src") && o(this).attr("src", d)
                    });
                    var c = [], u = !1;
                    e[0].f7DestroyImagesLazyLoad = s, r(), e.hasClass("page") && e.once("page:beforeremove", s), t(), e.once("page:afteranimation", t)
                }
            }
        ...
        var h = function (e, a) {
            ...
            var r = this;
            if (r.params = a, r.container = o(e), 0 !== r.container.length) return r.params.autoLayout && r.container.addClass("messages-auto-layout"), r.params.newMessagesFirst && r.container.addClass("messages-new-first"), r.pageContainer = r.container.parents(".page").eq(0), r.pageContent = r.pageContainer.find(".page-content"), r.template = Template7.compile(r.params.messageTemplate), r.layout = function () {
                r.container.hasClass("messages-auto-layout") || r.container.addClass("messages-auto-layout"), r.container.find(".message").each(function () {
                    ...
                    if (e.find(".message-text img").length > 0) {
                        for (var a = e.find(".message-text")[0].childNodes, t = !0, n = 0; n < a.length; n++) 1 === a[n].nodeType && "img" !== a[n].nodeName.toLowerCase() && (t = !1), 3 === a[n].nodeType && "" !== a[n].textContent.trim() && (t = !1);
                ...
                for (n = 0; n < e.length; n++) {
                    var s = e[n] || {};
                    s.type = s.type || "sent", s.text && (s.hasImage = s.text.indexOf("<img") >= 0, s.onlyImage === !1 && (s.hasImage = !1), t && (s.position = "append" === a ? "bottom" : "top"), i += r.template(s))
                }
                var o = r.pageContent[0].scrollHeight, l = r.pageContent[0].offsetHeight,
                    p = r.pageContent[0].scrollTop;
                if (r.container[a](i), r.params.autoLayout && r.layout(), "prepend" === a && (r.pageContent[0].scrollTop = p + (r.pageContent[0].scrollHeight - o)), r.params.scrollMessages && "append" === a && !r.params.newMessagesFirst || "prepend" === a && r.params.newMessagesFirst) if (r.params.scrollMessagesOnlyOnEdge) {
                    var d = !1;
                    r.params.newMessagesFirst ? 0 === p && (d = !0) : p - (o - l) >= -10 && (d = !0), d && r.scrollMessages(t ? void 0 : 0)
                } else r.scrollMessages(t ? void 0 : 0);
                var c = r.container.find(".message");
                if (1 === e.length) return "append" === a ? c[c.length - 1] : c[0];
                var u = [];
                if ("append" === a) for (n = c.length - e.length; n < c.length; n++) u.push(c[n]); else for (n = 0; n < e.length; n++) u.push(c[n]);
                return u
            }, r.removeMessage = function (e) {
                return e = o(e), 0 !== e.length && (e.remove(), r.params.autoLayout && r.layout(), !0)
                ...
                r = null
            }, r.init(), r.container[0].f7Messages = r, r
        };
        i.messages = function (e, a) {
            ...
            function a(e) {
                i.allowSwipeout && (s = !1, r = !0, l = void 0, E.x = "touchstart" === e.type ? e.targetTouches[0].pageX : e.pageX, E.y = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, p = (new Date).getTime())
            }
            ...
            function t(e) {
                if (r) {
                    var a = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX,
                        t = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY;
                    if ("undefined" == typeof l && (l = !!(l || Math.abs(t - E.y) > Math.abs(a - E.x))), l) return void(r = !1);
                    if (!s) {
                    ...
                    if (s = !0, e.preventDefault(), d = a - E.x, v = d, b && ("right" === w ? v -= g : v += h), v > 0 && 0 === f.length || v < 0 && 0 === m.length) {
            ...
            function n(e) {
                ...
                if (n = "to-left" === x ? m : f, t = "to-left" === x ? g : h, a = T < 300 && (d < -10 && "to-left" === x || d > 10 && "to-right" === x) || T >= 300 && Math.abs(v) > t / 2 ? "open" : "close", T < 300 && (0 === Math.abs(v) && (a = "close"), Math.abs(v) === t && (a = "open")), "open" === a) {
                    i.swipeoutOpenedEl = c, c.trigger("open swipeout:open"), c.addClass("swipeout-opened transitioning");
                    var k = "to-left" === x ? -t : t;
                    if (u.transform("translate3d(" + k + "px,0,0)"), n.addClass("swipeout-actions-opened"), l = "to-left" === x ? y : C) for (w = 0; w < l.length; w++) o(l[w]).transform("translate3d(" + k + "px,0,0)");
                    S && m.find(".swipeout-overswipe")[0].click(), P && f.find(".swipeout-overswipe")[0].click()
                } else c.trigger("close swipeout:close"), i.swipeoutOpenedEl = void 0, c.addClass("transitioning").removeClass("swipeout-opened"), u.transform(""), n.removeClass("swipeout-actions-opened");
                var M;
                if (C && C.length > 0 && C !== l) for (w = 0; w < C.length; w++) M = C[w]._buttonOffset, "undefined" == typeof M && (C[w]._buttonOffset = h - C[w].offsetLeft - C[w].offsetWidth), o(C[w]).transform("translate3d(" + M + "px,0,0)");
                if (y && y.length > 0 && y !== l) for (w = 0; w < y.length; w++) M = y[w]._buttonOffset, "undefined" == typeof M && (y[w]._buttonOffset = y[w].offsetLeft), o(y[w]).transform("translate3d(" + -M + "px,0,0)");
            ...
            var r, s, l, p, d, c, u, m, f, h, g, v, b, w, C, y, x, T, k, P, S, M, I, E = {},
                O = !!i.support.passiveListener && {passive: !1, capture: !1};
            ...
            }, O), e ? (o(e).on(i.touchEvents.start, a, O), o(e).on(i.touchEvents.move, t, O), o(e).on(i.touchEvents.end, n, O)) : (o(document).on(i.touchEvents.start, ".list-block li.swipeout", a, O), o(document).on(i.touchEvents.move, ".list-block li.swipeout", t, O), o(document).on(i.touchEvents.end, ".list-block li.swipeout", n, O))
            ...
            function t() {
                i.allowSwipeout = !0, e.hasClass("swipeout-opened") || (e.removeClass("transitioning"), s.transform(""), e.trigger("closed swipeout:closed"), a && a.call(e[0]), p && clearTimeout(p))
            }
            ...
            if (e = o(e), 0 !== e.length && e.hasClass("swipeout-opened")) {
                var n = e.find(".swipeout-actions-opened").hasClass("swipeout-actions-right") ? "right" : "left",
                    r = e.find(".swipeout-actions-opened").removeClass("swipeout-actions-opened"), s = r.children("a"),
                    l = r.outerWidth();
                i.allowSwipeout = !1, e.trigger("close swipeout:close"), e.removeClass("swipeout-opened").addClass("transitioning");
                var p;
            ...
            if (e = o(e), 0 !== e.length) {
                e.length > 1 && (e = o(e[0])), i.swipeoutOpenedEl = void 0, e.trigger("delete swipeout:delete"), e.css({height: e.outerHeight() + "px"});
                e[0].clientLeft;
                e.css({height: "0px"}).addClass("deleting transitioning").transitionEnd(function () {
                    ...
                    } else i.params.swipeoutRemoveWithTimeout ? setTimeout(function () {
                        e.remove()
                    }, 0) : e.remove()
                });
                var t = "-100%";
            ...
            return e = o(e), 0 === e.length && (e = o(".list-block.sortable")), e.toggleClass("sortable-opened"), e.hasClass("sortable-opened") ? e.trigger("open sortable:open") : e.trigger("close sortable:close"),
                e
        }, i.sortableOpen = function (e) {
            return e = o(e), 0 === e.length && (e = o(".list-block.sortable")), e.addClass("sortable-opened"), e.trigger("open sortable:open"), e
        }, i.sortableClose = function (e) {
            return e = o(e), 0 === e.length && (e = o(".list-block.sortable")), e.removeClass("sortable-opened"), e.trigger("close sortable:close"), e
        }, i.initSortable = function () {
            function e(e) {
                r = !1, n = !0, s = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, p = o(this).parent(), v = p.index(), c = p.parent().children("li"), g = p.parents(".sortable"), e.preventDefault(), i.allowPanelOpen = i.allowSwipeout = !1
            }
            ...
            function a(e) {
                if (n && p) {
                    ...
                    var t = l;
                    t < -u && (t = -u), t > m && (t = m), p.transform("translate3d(0," + t + "px,0)"), h = f = void 0, c.each(function () {
                        var e = o(this);
                        if (e[0] !== p[0]) {
                            var a = e[0].offsetTop, n = e.height(), r = p[0].offsetTop + t;
                            r >= a - n / 2 && p.index() < e.index() ? (e.transform("translate3d(0, " + -d + "px,0)"), f = e, h = void 0) : r <= a + n / 2 && p.index() > e.index() ? (e.transform("translate3d(0, " + d + "px,0)"), f = void 0, h || (h = e)) : o(this).transform("translate3d(0, 0%,0)")
                        }
                    })
                }
            }
            ...
            function t(e) {
                ...
                f && (p.insertAfter(f), p.trigger("sort sortable:sort", {
                    ...
                    startIndex: v,
                    newIndex: p.index()
                })), (f || h) && g.hasClass("virtual-list") && (a = g[0].f7VirtualList, t = p[0].f7VirtualListIndex, s = h ? h[0].f7VirtualListIndex : f[0].f7VirtualListIndex, a && a.moveItem(t, s)), f = h = void 0, n = !1, r = !1
            }

            var n, r, s, l, p, d, c, u, m, f, h, g, v, b = !!i.support.passiveListener && {passive: !1, capture: !1};
            o(document).on(i.touchEvents.start, ".list-block.sortable .sortable-handler", e, b), i.support.touch ? (o(document).on(i.touchEvents.move, ".list-block.sortable .sortable-handler", a, b), o(document).on(i.touchEvents.end, ".list-block.sortable .sortable-handler", t, b)) : (o(document).on(i.touchEvents.move, a, b), o(document).on(i.touchEvents.end, t, b))
            ...
            a = e.is(".smart-select") ? e : e.find(".smart-select"), 0 !== a.length && a.each(function () {
                ...
                if (0 !== a.length) {
                    var t = a[0];
                    if (0 !== t.length) {
                        for (var n, r = [], i = 0; i < t.length; i++) t[i].selected && (n = t[i].dataset ? t[i].dataset.displayAs : o(t[i]).data("display-as"), n && "undefined" != typeof n ? r.push(n) : r.push(t[i].textContent.trim()));
                        var s = e.find(".item-after");
                        if (0 === s.length) e.find(".item-inner").append('<div class="item-after">' + r.join(", ") + "</div>"); else {
                            var l = s.text();
                            if (s.hasClass("smart-select-value")) for (i = 0; i < t.length; i++) t[i].selected = t[i].textContent.trim() === l.trim(); else s.text(r.join(", "))
                        }
                        a.on("change", function () {
                            for (var a = [], n = 0; n < t.length; n++) if (t[n].selected) {
                                var r = t[n].dataset ? t[n].dataset.displayAs : o(t[n]).data("display-as");
                                r && "undefined" != typeof r ? a.push(r) : a.push(t[n].textContent.trim())
                            }
            ...
            function t() {
                ...
                if (0 !== a.length) {
                    var t, n = parseInt(a.css("padding-top"), 10), r = parseInt(a.css("padding-bottom"), 10),
                        i = a[0].offsetHeight - n - ie.height(), s = a[0].scrollHeight - n - ie.height(),
                        o = e.offset().top - n + e[0].offsetHeight;
                    if (o > i) {
                        var l = a.scrollTop() + o - i;
                        l + i > s && (t = l + i - s + r, i === s && (t = ie.height()), a.css({"padding-bottom": t + "px"})), a.scrollTop(l, 300)
                    }
                }
            }
            ...
            function r(e) {
                k.selectedOptions.length >= F ? e.find('input[type="checkbox"]').each(function () {
            ...
            function s(a) {
                ...
                F && r(a), g && a.find('input[type="radio"][name="' + q + '"]:checked').parents("label").once("click", function () {
                    "popup" === c ? i.closeModal(re) : "picker" === c ? i.closeModal(ie) : d.router.back()
                }), a.on("change", 'input[name="' + q + '"]', function () {
                    var t, n, s, l = this, p = l.value, u = [];
                    if ("checkbox" === l.type) {
                        for (var m = 0; m < k.options.length; m++) t = k.options[m], t.value === p && (t.selected = l.checked), t.selected && (s = t.dataset ? t.dataset.displayAs : o(t).data("display-as"), n = s && "undefined" != typeof s ? s : t.textContent, u.push(n.trim()));
                        F && r(a)
                    ...
                    P.trigger("change"), e.find(".item-after").text(u.join(", ")), g && "radio" === Y && ("popup" === c ? i.closeModal(re) : "picker" === c ? i.closeModal(ie) : d.router.back())
                })
            }
            ...
            if (e = o(e), 0 !== e.length) {
                ...
                if (0 !== d.length) {
                    ...
                    if (!(k.disabled || e.hasClass("disabled") || P.hasClass("disabled"))) {
                        ...
                        var G = i._compiledTemplates.smartSelectItem, j = "";
                        if (!C) for (var _ = 0; _ < R.length; _++) j += G(R[_]);
                        var U, J, Q = "", K = "", Z = "", $ = "";
                        ...
                        var ee, ae, te = "smart-select-" + q,
                            ne = "undefined" == typeof e.data("searchbar") ? i.params.smartSelectSearchbar : "true" === e.data("searchbar");
                        ne && (ee = e.data("searchbar-placeholder") || "Search", ae = e.data("searchbar-cancel") || "Cancel");
                        var re, ie,
                            se = '<form class="searchbar searchbar-init" data-search-list=".smart-select-list-' + V + '" data-search-in=".item-title"><div class="searchbar-input"><input type="search" placeholder="' + ee + '"><a href="#" class="searchbar-clear"></a></div>' + (x ? "" : '<a href="#" class="searchbar-cancel">' + ae + "</a>") + '</form><div class="searchbar-overlay"></div>',
                            oe = ("picker" !== c && "through" === J ? U : "") + '<div class="pages">  <div data-page="' + te + '" data-select-name="' + W + '" class="page smart-select-page ' + K + " " + Z + " " + $ + '">' + ("picker" !== c && "fixed" === J ? U : "") + (ne ? se : "") + '    <div class="page-content">' + ("picker" !== c && "static" === J ? U : "") + '      <div class="list-block ' + (C ? "virtual-list" : "") + " smart-select-list-" + V + " " + (v ? "theme-" + v : "") + '">        <ul>' + (C ? "" : j) + "        </ul>      </div>    </div>  </div></div>";
                        "popup" === c ? (a ? (re = o(".popup.smart-select-popup .view"), re.html(oe)) : (re = i.popup('<div class="popup smart-select-popup smart-select-popup-' + q + '"><div class="view navbar-fixed">' + oe + "</div></div>"), re = o(re)), i.initPage(re.find(".page")), s(re)) : "picker" === c ? (a ? (ie = o(".picker-modal.smart-select-picker .view"), ie.html(oe)) : (ie = i.pickerModal('<div class="picker-modal smart-select-picker smart-select-picker-' + q + '"' + (T ? ' style="height:' + T + '"' : "") + ">" + Q + '<div class="picker-modal-inner"><div class="view">' + oe + "</div></div></div>"), ie = o(ie), t(), o("html").on("click", n), ie.once("picker:close", function () {
                            e[0].f7SmartSelectPicker = void 0, o("html").off("click", n), e.parents(".page-content").css({paddingBottom: ""})
                        }), e[0].f7SmartSelectPicker = ie[0]), i.initPage(ie.find(".page")), s(ie)) : (o(document).once("page:init", ".smart-select-page", p), d.router.load({
                            content: oe,
                            reload: !!a || void 0
                        }))
                    }
        ...
        var g = function (e, a) {
            ...
            var r = this;
            r.listBlock = o(e), r.params = a, r.items = r.params.items, r.params.showFilteredItemsOnly && (r.filteredItems = []), r.params.template && !r.params.renderItem && ("string" == typeof r.params.template ? r.template = l.compile(r.params.template) : "function" == typeof r.params.template && (r.template = r.params.template)), r.pageContent = r.listBlock.parents(".page-content");
            var s;
            ...
            return r.setListSize = function () {
                ...
                } else f = Math.ceil(e.length / r.params.cols) * r.params.height, d = Math.ceil(p / r.params.height), c = r.params.rowsBefore || 2 * d, u = r.params.rowsAfter || d, m = d + c + u, h = c / 2 * r.params.height;
                ...
                var a, t = 0;
                if (g) for (var n = 0; n < e; n++) t += r.heights[n]; else t = e * r.params.height;
                ...
                r._isVisible(r.listBlock[0]) && (r.setListSize(), r.render(!0))
            }, r.attachEvents = function (e) {
                var a = e ? "off" : "on";
                r.pageContent[a]("scroll", r.handleScroll), r.listBlock.parents(".tab").eq(0)[a]("tab:show", r.handleResize), r.listBlock.parents(".panel").eq(0)[a]("panel:open", r.handleResize), r.listBlock.parents(".popup").eq(0)[a]("popup:open", r.handleResize), i["on" === a ? "onResize" : "offResize"](r.handleResize)
            }, r.init = function () {
                ...
                if (e !== a) {
                    ...
                    if (a >= r.items.length ? (r.items.push(t), a = r.items.length - 1) : r.items.splice(a, 0, t), r.params.cache) {
                        ...
                        for (var i in r.domCache) {
                            var s = parseInt(i, 10), o = e < a ? e : a, l = e < a ? a : e, p = e < a ? -1 : 1;
                            (s < o || s > l) && (n[s] = r.domCache[s]), s === o && (n[l] = r.domCache[s]), s > o && s <= l && (n[s + p] = r.domCache[s])
                        }
                        r.domCache = n
                    }
                    r.update()
        ...
        i.virtualList = function (e, a) {
                ...
                if (d) {
                    ...
                    if (a && t) {
                        ...
                        if (v = h[0].scrollTop, "undefined" == typeof b && 0 !== v && (b = !0), !c) {
                            ...
                            C && (w = h.attr("data-ptr-distance"), w.indexOf("%") >= 0 && (w = h[0].offsetHeight * parseInt(w, 10) / 100)), P = h.hasClass("refreshing") ? w : 0, k = h[0].scrollHeight === h[0].offsetHeight || "ios" !== i.device.os
                        }
                        return c = !0, m = t - x.y, m > 0 && v <= 0 || v < 0 ? ("ios" === i.device.os && parseInt(i.device.osVersion.split(".")[0], 10) > 7 && 0 === v && !b && (k = !0), k && (e.preventDefault(), g = Math.pow(m, .85) + P, h.transform("translate3d(0," + g + "px,0)")), k && Math.pow(m, .85) > w || !k && m >= 2 * w ? (T = !0, h.addClass("pull-up").removeClass("pull-down")) : (T = !1, h.removeClass("pull-up").addClass("pull-down")), y || (h.trigger("pullstart ptr:pullstart"), y = !0), h.trigger("pullmove ptr:pullmove", {
                            event: e,
                            scrollTop: v,
                            translate: g,
                            touchesDiff: m
            ...
            function n(e) {
                if (!("touchend" === e.type && e.changedTouches && e.changedTouches.length > 0 && p && e.changedTouches[0].identifier !== p)) {
                    ...
                    g && (h.addClass("transitioning"), g = 0), h.transform(""), T ? (h.addClass("refreshing"), h.trigger("refresh ptr:refresh", {
                        done: function () {
                            i.pullToRefreshDone(h)
                        }
                    })) : h.removeClass("pull-down"), d = !1, c = !1, y && h.trigger("pullend ptr:pullend")
                }
            }

            function r() {
                l.off(i.touchEvents.start, a, I), l.off(i.touchEvents.move, t, E), l.off(i.touchEvents.end, n, I)
            }
            ...
            if (l.hasClass("pull-to-refresh-content") || (l = l.find(".pull-to-refresh-content")), l && 0 !== l.length) {
                ...
                (S.find(".navbar").length > 0 || S.parents(".navbar-fixed, .navbar-through").length > 0 || S.hasClass("navbar-fixed") || S.hasClass("navbar-through")) && (M = !0), S.hasClass("no-navbar") && (M = !1), M || l.addClass("pull-to-refresh-no-navbar"), h = l, h.attr("data-ptr-distance") ? C = !0 : w = 44;
                var I = !("touchstart" !== i.touchEvents.start || !i.support.passiveListener) && {
                    passive: !0,
                    capture: !1
                }, E = !!i.support.passiveListener && {passive: !1, capture: !1};
                l.on(i.touchEvents.start, a, I), l.on(i.touchEvents.move, t, E), l.on(i.touchEvents.end, n, I), 0 !== S.length && (l[0].f7DestroyPullToRefresh = r, S.on("page:beforeremove", s))
            }
            ...
            e = o(e), 0 === e.length && (e = o(".pull-to-refresh-content")), e.hasClass("refreshing") || (e.addClass("transitioning refreshing"), e.trigger("refresh ptr:refresh", {
                done: function () {
            ...
            0 !== t.length && (i.attachInfiniteScroll(t), e.on("page:beforeremove", a))
            ...
            o(e).each(function () {
                var e = o(this);
                if (a = a || e.find(".tab-link.active"), a && a.length > 0) {
                    var t, n;
                    e.hasClass("tabbar-scrollable") ? (t = a[0].offsetWidth + "px", n = a[0].offsetLeft + "px") : (t = 1 / e.find(".tab-link").length * 100 + "%", n = 100 * (i.rtl ? -a.index() : a.index()) + "%"), e.find(".tab-link-highlight").css({width: t}).transform("translate3d(" + n + ",0,0)")
                }
            })
            ...
            e = o(e);
            var t = e.find(".tabbar");
            0 === t.length && e.hasClass("tabbar") && (t = e), t.length > 0 && (0 === t.find(".tab-link-highlight").length && t.find(".toolbar-inner").append('<span class="tab-link-highlight"></span>'), a(), i.onResize(a), e.once("page:beforeremove", function () {
                i.offResize(a)
            }))
            ...
            var r = o(e);
            if (2 === arguments.length && "boolean" == typeof arguments[1] && (e = arguments[0], t = arguments[1]), 3 === arguments.length && "boolean" == typeof arguments[1] && "boolean" == typeof arguments[2] && (e = arguments[0], t = arguments[1], n = arguments[2]), "undefined" == typeof t && (t = !0), 0 === r.length) return !1;
            if (r.hasClass("active")) return n && r.trigger("show tab:show"), !1;
            var s = r.parent(".tabs");
            ...
            var d, c = s.parent().hasClass("tabs-swipeable-wrap");
            c && (d = s.parent()[0].swiper, d.activeIndex !== r.index() && d.slideTo(r.index(), t ? void 0 : 0, !1));
            var u = s.children(".tab.active").removeClass("active").trigger("hide tab:hide");
            if (r.addClass("active"), r.trigger("show tab:show"), !l && !c && r.find(".navbar").length > 0) {
                var m;
                m = r.hasClass(i.params.viewClass) ? r[0] : r.parents("." + i.params.viewClass)[0], i.sizeNavbars(m)
            }
            if (a ? a = o(a) : (a = o("string" == typeof e ? '.tab-link[href="' + e + '"]' : '.tab-link[href="#' + r.attr("id") + '"]'), (!a || a && 0 === a.length) && o("[data-tab]").each(function () {
                    r.is(o(this).attr("data-tab")) && (a = o(this))
                })), 0 !== a.length) {
                var f;
                if (u && u.length > 0) {
                    var h = u.attr("id");
                    h && (f = o('.tab-link[href="#' + h + '"]')), (!f || f && 0 === f.length) && o("[data-tab]").each(function () {
                        u.is(o(this).attr("data-tab")) && (f = o(this))
                    })
                }
                if (a && a.length > 0 && (a.addClass("active"), i.params.material)) {
                    var g = a.parents(".tabbar");
                    g.length > 0 && (0 === g.find(".tab-link-highlight").length && g.find(".toolbar-inner").append('<span class="tab-link-highlight"></span>'), i.materialTabbarSetHighlight(g, a))
                }
            ...
            function l(e) {
                var a = o(e);
                return ("input" !== e.nodeName.toLowerCase() || "file" !== e.type && "range" !== e.type) && (("select" !== e.nodeName.toLowerCase() || !i.device.android) && (!(a.hasClass("no-fastclick") || a.parents(".no-fastclick").length > 0) && (!i.params.fastClicksExclude || !a.is(i.params.fastClicksExclude))))
            }

            function p(e) {
                if (document.activeElement === e) return !1;
                var a = e.nodeName.toLowerCase(), t = "button checkbox file image radio submit".split(" ");
                return !e.disabled && !e.readOnly && ("textarea" === a || ("select" === a ? !i.device.android : "input" === a && t.indexOf(e.type) < 0 || void 0))
            }

            function d(e) {
                e = o(e);
                var a = !0;
                return (e.is("label") || e.parents("label").length > 0) && (a = !i.device.android && !(!i.device.ios || !e.is("input"))), a
            }
            ...
            function h(e, a, t) {
                if (t) {
                    ...
                    q[0].clientLeft;
                    W = "translate3d(" + (-r.x + s / 2) + "px, " + (-r.y + i / 2) + "px, 0) scale(1)", q.transform(W)
                }
            }
            ...
            function g() {
                if (q) {
                    ...
                    q.addClass("ripple-wave-fill").transform(W.replace("scale(1)", "scale(1.01)")).transitionEnd(function () {
                        clearTimeout(a);
                        var e = o(this).addClass("ripple-wave-out").transform(W.replace("scale(1)", "scale(1.01)"));
            ...
            function v(e, t, n) {
                return F = f(e), F && 0 !== F.length ? void(a(F) ? X = setTimeout(function () {
                    h(S, M, F)
                }, 80) : h(S, M, F)) : void(F = void 0)
            }
            ...
            function w() {
                q ? g() : F && !B ? (clearTimeout(X), h(S, M, F), setTimeout(g, 0)) : g()
            }

            function C(e) {
                var a = e.changedTouches[0], t = document.createEvent("MouseEvents"), n = "click";
                i.device.android && "select" === E.nodeName.toLowerCase() && (n = "mousedown"), t.initMouseEvent(n, !0, !0, window, 1, a.screenX, a.screenY, a.clientX, a.clientY, !1, !1, !1, !1, 0, null), t.forwardedTouchEvent = !0, E.dispatchEvent(t)
            }

            function y(r) {
                if (B = !1, N = !1, r.targetTouches.length > 1) return A && n(), !0;
                if (r.touches.length > 1 && A && n(), i.params.tapHold && (H && clearTimeout(H), H = setTimeout(function () {
                    ...
                    }, i.params.tapHoldDelay)), Y && clearTimeout(Y), V = l(r.target), !V) return O = !1, !0;
                if (i.device.ios || i.device.android && "getSelection" in window) {
                    var p = window.getSelection();
                    if (p.rangeCount && p.focusNode !== document.body && (!p.isCollapsed || document.activeElement === p.focusNode)) return z = !0, !0;
                    z = !1
                }
                i.device.android && s(r.target) && document.activeElement.blur(), O = !0, E = r.target, I = (new Date).getTime(), S = r.targetTouches[0].pageX, M = r.targetTouches[0].pageY, i.device.ios && (D = void 0, o(E).parents().each(function () {
                    var e = this;
                    e.scrollHeight > e.offsetHeight && !D && (D = e, D.f7ScrollTop = D.scrollTop)
                })), r.timeStamp - L < i.params.fastClicksDelayBetweenClicks && r.preventDefault(), i.params.activeState && (A = e(E), a(A) ? R = setTimeout(t, 80) : t()), i.params.material && i.params.materialRipple && v(E, S, M)
            }
            ...
            function x(e) {
                if (O) {
                    ...
                    a && (O = !1, E = null, B = !0, i.params.tapHold && clearTimeout(H), i.params.activeState && (clearTimeout(R), n()), i.params.material && i.params.materialRipple && b())
                }
            }

            function T(e) {
                if (clearTimeout(R), clearTimeout(H), !O) return !z && V && (i.device.android && !e.cancelable || e.preventDefault()), !0;
                if (document.activeElement === e.target) return i.params.activeState && n(), i.params.material && i.params.materialRipple && w(), !0;
                if (z || e.preventDefault(), e.timeStamp - L < i.params.fastClicksDelayBetweenClicks) return setTimeout(n, 0), !0;
                if (L = e.timeStamp, O = !1, i.device.ios && D && D.scrollTop !== D.f7ScrollTop) return !1;
                if (i.params.activeState && (t(), setTimeout(n, 0)), i.params.material && i.params.materialRipple && w(), p(E)) {
                    if (i.device.ios && i.device.webView) return event.timeStamp - I > 159 ? (E = null, !1) : (E.focus(), !1);
                    E.focus()
                }
            ...
            function k(e) {
                O = !1, E = null, clearTimeout(R), clearTimeout(H), i.params.activeState && n(), i.params.material && i.params.materialRipple && w()
            }

            function P(e) {
                var a = !1;
                return O ? (E = null, O = !1, !0) : "submit" === e.target.type && 0 === e.detail || "file" === e.target.type || (E || r(e.target) || (a = !0), V || (a = !0), document.activeElement === E && (a = !0), e.forwardedTouchEvent && (a = !0), e.cancelable || (a = !0), i.params.tapHold && i.params.tapHoldPreventClicks && N && (a = !1), a || (e.stopImmediatePropagation(), e.stopPropagation(), E ? (d(E) || B) && e.preventDefault() : e.preventDefault(), E = null), Y = setTimeout(function () {
                    V = !1
            ...
            var S, M, I, E, O, z, D, L, B, N, H, A, R, V, Y, q, F, W, X;
            ...
            function a(e) {
                ...
                var r = a.dataset();
                if (a.hasClass("smart-select") && i.smartSelectOpen && i.smartSelectOpen(a), a.hasClass("open-panel") && (1 === o(".panel").length ? o(".panel").hasClass("panel-left") ? i.openPanel("left") : i.openPanel("right") : "right" === r.panel ? i.openPanel("right") : i.openPanel("left")), a.hasClass("close-panel") && i.closePanel(), a.hasClass("panel-overlay") && (o(".panel.active").trigger("panel:overlay-click"), i.params.panelsCloseByOutside && i.closePanel()), a.hasClass("open-popover")) {
                    var s;
                ...
                var c;
                if (a.hasClass("open-login-screen") && (c = r.loginScreen ? r.loginScreen : ".login-screen", i.loginScreen(c)), a.hasClass("close-login-screen") && i.closeModal(".login-screen.modal-in"), a.hasClass("modal-overlay") && (o(".modal.modal-in").length > 0 && i.params.modalCloseByOutside && i.closeModal(".modal.modal-in"), o(".actions-modal.modal-in").length > 0 && i.params.actionsCloseByOutside && i.closeModal(".actions-modal.modal-in"), o(".popover.modal-in").length > 0 && i.params.popoverCloseByOutside && i.closeModal(".popover.modal-in")), a.hasClass("popup-overlay") && o(".popup.modal-in").length > 0 && i.params.popupCloseByOutside && i.closeModal(".popup.modal-in"), a.hasClass("picker-modal-overlay") && o(".picker-modal.modal-in").length > 0 && i.closeModal(".picker-modal.modal-in"), a.hasClass("close-picker")) {
                ...
                if (a.hasClass("floating-button") && a.parent().hasClass("speed-dial") && a.parent().toggleClass("speed-dial-opened"), a.hasClass("close-speed-dial") && o(".speed-dial-opened").removeClass("speed-dial-opened"), (!i.params.ajaxLinks || a.is(i.params.ajaxLinks)) && n && i.params.router) {
                    n && e.preventDefault();
            ...
            if (o(document).on("click", "a, .open-panel, .close-panel, .panel-overlay, .modal-overlay, .popup-overlay, .swipeout-delete, .swipeout-close, .close-popup, .open-popup, .open-popover, .open-login-screen, .close-login-screen .smart-select, .toggle-sortable, .open-sortable, .close-sortable, .accordion-item-toggle, .close-picker, .picker-modal-overlay", a), (i.params.scrollTopOnNavbarClick || i.params.scrollTopOnStatusbarClick) && o(document).on("click", ".statusbar-overlay, .navbar .center", e), i.support.touch && !i.device.android) {
                var n = !!i.support.passiveListener && {passive: !1, capture: !1};
                o(document).on(i.params.fastClicks ? "touchstart" : "touchmove", ".panel-overlay, .modal-overlay, .preloader-indicator-overlay, .popup-overlay, .searchbar-overlay", t, n)
            }
        };
        var v = [];
        i.getSize = function () {
            var e = i.root.offset();
            i.width = i.root[0].offsetWidth, i.height = i.root[0].offsetHeight, i.left = e.left, i.top = e.top
        }, i.onResize = function (e) {
            v.push(e)
        }, i.offResize = function (e) {
            for (var a = 0; a < v.length; a++) v[a] === e && v.splice(a, 1)
        }, i.resize = function () {
            r(), i.getSize(), i.sizeNavbars && i.sizeNavbars();
            for (var e = 0; e < v.length; e++) v[e]()
        }, i.orientationchange = function () {
            i.device && i.device.minimalUi && (90 !== window.orientation && window.orientation !== -90 || (document.body.scrollTop = 0)), r()
        }, i.initResize = function () {
            o(window).on("resize", i.resize), o(window).on("orientationchange", i.orientationchange), i.getSize()
        ...
        }, i.formToJSON = i.formToData, i.formFromData = function (e, a) {
            if (e = o(e), 1 !== e.length) return !1;
            var t = ["submit", "image", "button", "file"], n = [];
            e.find("input, select, textarea").each(function () {
                var r = o(this), i = r.attr("name"), s = r.attr("type"), l = this.nodeName.toLowerCase();
                if ("undefined" != typeof a[i] && null !== a[i] && !(t.indexOf(s) >= 0) && !(n.indexOf(i) >= 0) && i) {
                    ...
                    "select" !== l && "input" !== l && "textarea" !== l || r.trigger("change")
                }
            }), e.trigger("formFromJSON formFromData form:fromdata", {formData: a})
        }, i.formFromJSON = i.formFromData, i.initFormsStorage = function (e) {
            function a() {
                var e = o(this), a = e[0].id;
                if (a) {
                    var t = i.formToData(e);
                    t && (i.formStoreData(a, t), e.trigger("store form:storedata", {data: t}))
                }
            }
            ...
            if ("change" !== e.type || a.hasClass("ajax-submit-onchange")) {
                ...
                var t = (a.attr("method") || "GET").toUpperCase(), n = a.prop("enctype") || a.attr("enctype"),
                    r = a.attr("action");
                if (r) {
                    var s;
                    ...
                    var l = o.ajax({
                        method: t, url: r, contentType: n, data: s, beforeSend: function (e) {
                            a.trigger("beforeSubmit form:beforesend", {data: s, xhr: e})
                        }, error: function (e) {
                            a.trigger("submitError form:error", {data: s, xhr: e})
                        }, success: function (e) {
            ...
            function t(e) {
                ...
                if (!(n.indexOf(r) >= 0)) {
                    var i = a.add(a.parents(".item-input, .input-field")).add(a.parents(".item-inner").eq(0));
                    0 !== i.length && (t && "string" == typeof t && "" !== t.trim() || Array.isArray(t) && t.length > 0 ? i.addClass("not-empty-state") : i.removeClass("not-empty-state"))
                }
            }

            var n = ["checkbox", "button", "submit", "range", "radio", "image"];
            o(document).on("change", "input, textarea, select", t, !0), o(document).on("focus", "input, textarea, select", e, !0), o(document).on("blur", "input, textarea, select", a, !0)
        ...
        var b = function (e) {
            ...
            var r = a.params.photoTemplate || '<div class="photo-browser-slide swiper-slide"><span class="swiper-zoom-container"><img src="{{js "this.url || this"}}"></span></div>',
                s = a.params.lazyPhotoTemplate || '<div class="photo-browser-slide photo-browser-slide-lazy swiper-slide"><div class="preloader {{@root.preloaderColorClass}}">{{#if @root.material}}{{@root.materialPreloaderHtml}}{{/if}}</div><span class="swiper-zoom-container"><img data-src="{{js "this.url || this"}}" class="swiper-lazy"></span></div>',
            ...
            a.activeIndex = a.params.initialSlide, a.openIndex = a.activeIndex, a.opened = !1, a.open = function (e) {
                ...
                a.close(), o(a.popup).off("page:beforeinit", a.onPopupClose)
            ...
            var f, h, g, v, b, w = !1, C = !0, y = !1;
            return a.swipeCloseTouchStart = function (e, a) {
                C && (w = !0)
            }, a.swipeCloseTouchMove = function (e, t) {
                if (w) {
                    y || (y = !0, h = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, v = a.swiper.slides.eq(a.swiper.activeIndex), b = (new Date).getTime()), t.preventDefault(), g = "touchmove" === t.type ? t.targetTouches[0].pageY : t.pageY, f = h - g;
                    var n = 1 - Math.abs(f) / 300;
                    v.transform("translate3d(0," + -f + "px,0)"), a.swiper.container.css("opacity", n).transition(0)
                }
            }, a.swipeCloseTouchEnd = function (e, t) {
                if (w = !1, !y) return void(y = !1);
                y = !1, C = !1;
                var n = Math.abs(f), r = (new Date).getTime() - b;
                return r < 300 && n > 20 || r >= 300 && n > 100 ? void setTimeout(function () {
                    "standalone" === a.params.type && a.close(), "popup" === a.params.type && i.closeModal(a.popup), a.params.onSwipeToClose && a.params.onSwipeToClose(a), C = !0
                }, 0) : (0 !== n ? v.addClass("transitioning").transitionEnd(function () {
                    C = !0, v.removeClass("transitioning")
                }) : C = !0, a.swiper.container.css("opacity", "").transition(""), void v.transform(""))
            }, a
        };
        ...
        var w = function (e) {
            function a(e) {
                ...
                r.params.source && r.params.source(r, a, function (e) {
                    var t = "", n = r.params.limit ? Math.min(r.params.limit, e.length) : e.length;
                    r.items = e;
                    var i, s;
                    for (r.params.highlightMatches && (a = a.replace(/[\-\[\]\/\{\}\(\)\*\+\?\.\\\^\$\|]/g, "\\$&"), s = new RegExp("(" + a + ")", "i")), i = 0; i < n; i++) {
                        var o = "object" == typeof e[i] ? e[i][r.params.valueProperty] : e[i],
                            l = "object" != typeof e[i] ? e[i] : e[i][r.params.textProperty];
                        t += r.dropdownItemTemplate({
                            value: o,
                            text: r.params.highlightMatches ? l.replace(s, "<b>$1</b>") : l
                        })
                    }
                    "" === t && "" === a && r.params.dropdownPlaceholderText && (t += r.dropdownPlaceholderTemplate({text: r.params.dropdownPlaceholderText})), r.dropdown.find("ul").html(t)
                })
            }
            ...
            if (!r.params.input || (r.input = o(r.params.input), 0 !== r.input.length || "dropdown" !== r.params.openIn)) {
                ...
                return r.popup = void 0, r.dropdown = void 0, r.positionDropDown = function () {
                    var e = r.input.parents(".list-block"), a = r.input.parents(".page-content"),
                        t = (parseInt(a.css("padding-top"), 10), parseInt(a.css("padding-top"), 10)),
                        n = e.length > 0 ? e.offset().left - e.parent().offset().left : 0,
                        i = r.input.offset().left - (e.length > 0 ? e.offset().left : 0),
                        s = r.input.offset().top - (a.offset().top - a[0].scrollTop),
                        o = a[0].scrollHeight - t - (s + a[0].scrollTop) - r.input[0].offsetHeight;
                    r.dropdown.css({
                        left: (e.length > 0 ? n : i) + "px",
                        top: s + a[0].scrollTop + r.input[0].offsetHeight + "px",
                        width: (e.length > 0 ? e[0].offsetWidth : r.input[0].offsetWidth) + "px"
                    }), r.dropdown.children(".autocomplete-dropdown-inner").css({
                        maxHeight: o + "px",
                        paddingLeft: e.length > 0 && !r.params.expandInput ? i - (c ? 16 : 15) + "px" : ""
                    })
                    ...
                    function a(e) {
                        if (r.params.source) {
                            ...
                            r.params.source(r, e, function (n) {
                                var i = "", o = r.params.limit ? Math.min(r.params.limit, n.length) : n.length;
                                for (r.items = n, a = 0; a < o; a++) {
                                    var l = !1, p = "object" == typeof n[a] ? n[a][r.params.valueProperty] : n[a];
                                    for (t = 0; t < r.value.length; t++) {
                                        var d = "object" == typeof r.value[t] ? r.value[t][r.params.valueProperty] : r.value[t];
                                        d !== p && 1 * d !== 1 * p || (l = !0)
                                    }
                                    i += r.itemTemplate({
                                        value: p,
                                        text: "object" != typeof n[a] ? n[a] : n[a][r.params.textProperty],
                                ...
                                s.find(".autocomplete-found ul").html(i), 0 === n.length ? 0 !== e.length ? (s.find(".autocomplete-not-found").show(), s.find(".autocomplete-found, .autocomplete-values").hide()) : (s.find(".autocomplete-values").show(), s.find(".autocomplete-found, .autocomplete-not-found").hide()) : (s.find(".autocomplete-found").show(), s.find(".autocomplete-not-found, .autocomplete-values").hide())
                            })
                        }
                    }
                    ...
                    var n = e.detail.page;
                    if (r.page = o(n.container), r.pageData = n, n.name === h) {
                        var s = o(n.container), l = i.searchbar(s.find(".searchbar"), {
                        ...
                        r.searchbar = l, !r.params.multiple && r.params.backOnSelect && s.once("click", ".list-block label", function () {
                            "popup" === r.params.openIn ? i.closeModal(r.popup) : d.router.back({animatePages: r.params.openWithAnimation})
                        }), s.on("change", 'input[type="radio"], input[type="checkbox"]', function () {
                            var e, a, n, i, s = this, l = s.value,
                                p = (o(s).parents("li").find(".item-title").text(), o(s).parents(".autocomplete-values").length > 0);
                            if (p) {
                                if ("checkbox" === r.inputType && !s.checked) {
                                    for (e = 0; e < r.value.length; e++) i = "string" == typeof r.value[e] ? r.value[e] : r.value[e][r.params.valueProperty], i !== l && 1 * i !== 1 * l || r.value.splice(e, 1);
                                    t(), r.params.onChange && r.params.onChange(r, r.value)
                                }
                            } else {
                                for (e = 0; e < r.items.length; e++) n = "string" == typeof r.items[e] ? r.items[e] : r.items[e][r.params.valueProperty], n !== l && 1 * n !== 1 * l || (a = r.items[e]);
                                if ("radio" === r.inputType) r.value = [a]; else if (s.checked) r.value.push(a); else for (e = 0; e < r.value.length; e++) i = "string" == typeof r.value[e] ? r.value[e] : r.value[e][r.params.valueProperty], i !== l && 1 * i !== 1 * l || r.value.splice(e, 1);
                                t(), ("radio" === r.inputType && s.checked || "checkbox" === r.inputType) && r.params.onChange && r.params.onChange(r, r.value)
                            }
                        }), t(), r.params.requestSourceOnOpen && a(""), r.params.onOpen && r.params.onOpen(r)
                    }
                ...
                }, r.autoFocus = function (e) {
                    var a = this;
                    setTimeout(function () {
                        o(a).find("input[type=search]").focus()
                    }, 0)
                }, r.open = function () {
                    if (!r.opened) if (r.opened = !0, "dropdown" === r.params.openIn) {
                        ...
                        e.length && r.input.parents(".item-content").length > 0 && r.params.expandInput && r.input.parents(".item-content").addClass("item-content-dropdown-expand"), r.positionDropDown(), r.input.parents(".page-content").append(r.dropdown), r.dropdown.addClass("autocomplete-dropdown-in"), r.input.trigger("input"), i.onResize(r.positionDropDown), r.params.onOpen && r.params.onOpen(r)
                    } else o(document).once("page:init", ".autocomplete-page", r.pageInit), "popup" === r.params.openIn ? (r.popup = i.popup('<div class="popup autocomplete-popup autocomplete-popup-' + r.inputName + '"><div class="view navbar-fixed">' + y + "</div></div>", !0, r.params.openWithAnimation), r.popup = o(r.popup), r.params.autoFocus && (r.params.openWithAnimation ? r.popup.once("popup:opened", r.autoFocus) : r.autoFocus.bind(r.popup)()), r.popup.once("popup:closed", function () {
                        r.popup = void 0, r.opened = !1, r.params.onClose && r.params.onClose(r)
                    })) : (r.params.autoFocus && o(document).once(r.params.openWithAnimation ? "page:afteranimation" : "page:init", ".autocomplete-page", r.autoFocus), d.router.load({
                        content: y,
                        animatePages: r.params.openWithAnimation
                    }), o(document).once("page:back", ".autocomplete-page", function () {
                    ...
                    if (r.opened) {
                        if ("dropdown" === r.params.openIn) {
                            ...
                            r.dropdown.removeClass("autocomplete-dropdown-in").remove(), r.input.parents(".item-content-dropdown-expand").removeClass("item-content-dropdown-expand"), r.opened = !1, i.offResize(r.positionDropDown), r.params.onClose && r.params.onClose(r)
                        }
        ...
        var C = function (e) {
            function a() {
                var e = !1;
                return p.params.convertToPopover || p.params.onlyInPopover ? (!p.inline && p.params.input && (p.params.onlyInPopover ? e = !0 : i.device.ios ? e = !!i.device.ipad : i.width >= 768 && (e = !0)), e) : e
            }
            ...
            return p.setValue = function (e, a) {
                ...
                var a, t, n = e || [], r = [];
                if (0 === p.cols.length) for (a = 0; a < p.params.cols.length; a++) t = p.params.cols[a], void 0 !== t.displayValues && void 0 !== t.values && void 0 !== t.values.indexOf(n[a]) ? r.push(t.displayValues[t.values.indexOf(n[a])]) : r.push(n[a]); else for (a = 0; a < p.cols.length; a++) p.cols[a].divider || (n.push(p.cols[a].value), r.push(p.cols[a].displayValue));
                n.indexOf(void 0) >= 0 || (p.value = n, p.displayValue = r, p.params.onChange && p.params.onChange(p, p.value, p.displayValue), p.input && p.input.length > 0 && (o(p.input).val(p.params.formatValue ? p.params.formatValue(p, p.value, p.displayValue) : p.value.join(" ")), o(p.input).trigger("change")))
                ...
                function n(e) {
                    y || C || (e.preventDefault(), C = !0, x = T = "touchstart" === e.type ? e.targetTouches[0].pageY : e.pageY, k = (new Date).getTime(), D = !0, S = I = o.getTranslate(m.wrapper[0], "y"))
                }

                function r(e) {
                    if (C) {
                        e.preventDefault(), D = !1, T = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, y || (o.cancelAnimationFrame(w), y = !0, S = I = o.getTranslate(m.wrapper[0], "y"), m.wrapper.transition(0));
                        var a = T - x;
                        I = S + a, M = void 0, I < v && (I = v - Math.pow(v - I, .8), M = "min"), I > b && (I = b + Math.pow(I - b, .8), M = "max"), m.wrapper.transform("translate3d(0," + I + "px,0)"), m.updateItems(void 0, I, 0, p.params.updateValuesOnTouchmove), O = I - E || I, z = (new Date).getTime(), E = I
                    }
                }
                ...
                function s(e) {
                    ...
                    var a, n;
                    P - k > 300 ? n = I : (a = Math.abs(O / (P - z)), n = I + O * p.params.momentumRatio), n = Math.max(Math.min(n, b), v);
                ...
                if (!m.divider) {
                    ...
                    m.setValue = function (e, a, n) {
                        ...
                        "undefined" == typeof a && (a = o.getTranslate(m.wrapper[0], "y")), "undefined" == typeof e && (e = -Math.round((a - b) / h)), e < 0 && (e = 0), e >= m.items.length && (e = m.items.length - 1);
                        var r = m.activeIndex;
                        ...
                        if (p.params.rotateEffect) {
                            ...
                            m.items.each(function () {
                                ...
                                l > 180 && (l = 180), l < -180 && (l = -180), Math.abs(i) > s ? e.addClass("picker-item-far") : e.removeClass("picker-item-far"), e.transform("translate3d(0, " + (-a + b) + "px, " + (u ? -110 : 0) + "px) rotateX(" + l + "deg)")
                            })
                        }
                    ...
                    var C, y, x, T, k, P, S, M, I, E, O, z, D = !0;
                    m.initEvents = function (e) {
                        var a = e ? "off" : "on", t = !!i.support.passiveListener && {passive: !1, capture: !1};
                        m.container[a](i.touchEvents.start, n, t), m.container[a](i.touchEvents.move, r, t), m.container[a](i.touchEvents.end, s, t), m.items[a]("click", l)
            ...
            }, i.onResize(n), p.columnHTML = function (e, a) {
                var t = "", n = "";
                if (e.divider) n += '<div class="picker-items-col picker-items-col-divider ' + (e.textAlign ? "picker-items-col-" + e.textAlign : "") + " " + (e.cssClass || "") + '">' + e.content + "</div>"; else {
                    for (var r = 0; r < e.values.length; r++) t += '<div class="picker-item" data-picker-value="' + e.values[r] + '"><span>' + (e.displayValues ? e.displayValues[r] : e.values[r]) + "</span></div>";
                ...
                var e = a();
                p.opened || (p.layout(), e ? (p.pickerHTML = '<div class="popover popover-picker-columns"><div class="popover-inner">' + p.pickerHTML + "</div></div>", p.popover = i.popover(p.pickerHTML, p.params.input, !0), p.container = o(p.popover).find(".picker-modal"), o(p.popover).on("popover:close", function () {
                    l()
                })) : p.inline ? (p.container = o(p.pickerHTML), p.container.addClass("picker-modal-inline"), o(p.params.container).append(p.container)) : (p.container = o(i.pickerModal(p.pickerHTML)), o(p.container).on("picker:close", function () {
                    l()
                ...
                if (p.opened && !p.inline) return t() ? void i.closeModal(p.popover) : void i.closeModal(p.container)
            }, p.destroy = function () {
                p.close(), p.params.input && p.input.length > 0 && p.input.off("click focus", r), o("html").off("click", s), i.offResize(n)
        ...
        var y = function (e) {
            ...
            function n(e) {
                ...
                return p.params.dateFormat.replace(/yyyy/g, a).replace(/yy/g, (a + "").substring(2)).replace(/mm/g, n < 10 ? "0" + n : n).replace(/m(\W+)/g, n + "$1").replace(/MM/g, p.params.monthNames[t]).replace(/M(\W+)/g, p.params.monthNamesShort[t] + "$1").replace(/dd/g, r < 10 ? "0" + r : r).replace(/d(\W+)/g, r + "$1").replace(/DD/g, p.params.dayNames[i]).replace(/D(\W+)/g, p.params.dayNamesShort[i] + "$1")
            }
            ...
            return p.animating = !1, p.addValue = function (e) {
                ...
                function a(e) {
                    if (r) {
                        ...
                        T = !1, s || (s = !0, b = p.wrapper[0].offsetWidth, w = p.wrapper[0].offsetHeight, p.wrapper.transition(0)), y = p.isH ? c - l : m - d, C = y / (p.isH ? b : w), v = 100 * (p.monthsTranslate * u + C), p.wrapper.transform("translate3d(" + (p.isH ? v : 0) + "%, " + (p.isH ? 0 : v) + "%, 0)")
                    }
                }

                function t(e) {
                    return r && s ? (r = s = !1, h = (new Date).getTime(), h - f < 300 ? Math.abs(y) < 10 ? p.resetMonth() : y >= 10 ? i.rtl ? p.nextMonth() : p.prevMonth() : i.rtl ? p.prevMonth() : p.nextMonth() : C <= -.5 ? i.rtl ? p.prevMonth() : p.nextMonth() : C >= .5 ? i.rtl ? p.nextMonth() : p.prevMonth() : p.resetMonth(), void setTimeout(function () {
                        T = !0
                    }, 100)) : void(r = s = !1)
                }
                ...
                function n(e) {
                    if (T) {
                        ...
                        if (0 === a.length && o(e.target).hasClass("picker-calendar-day") && (a = o(e.target)), 0 !== a.length && !a.hasClass("picker-calendar-day-disabled")) {
                            ...
                            p.params.onDayClick && p.params.onDayClick(p, a[0], t, n, r), (!a.hasClass("picker-calendar-day-selected") || p.params.multiple || p.params.rangePicker) && p.addValue(new Date(t, n, r, 0, 0, 0)), p.params.closeOnSelect && (p.params.rangePicker && 2 === p.value.length || !p.params.rangePicker) && p.close()
                        }
                    }
                }
                ...
                var k = !("touchstart" !== i.touchEvents.start || !i.support.passiveListener) && {
                    passive: !0,
                    capture: !1
                }, P = !!i.support.passiveListener && {passive: !1, capture: !1};
                p.params.touchMove && (p.wrapper.on(i.touchEvents.start, e, k), p.wrapper.on(i.touchEvents.move, a, P), p.wrapper.on(i.touchEvents.end, t, k)), p.container[0].f7DestroyCalendarEvents = function () {
                    p.container.find(".picker-calendar-prev-month").off("click", p.prevMonth), p.container.find(".picker-calendar-next-month").off("click", p.nextMonth), p.container.find(".picker-calendar-prev-year").off("click", p.prevYear), p.container.find(".picker-calendar-next-year").off("click", p.nextYear), p.wrapper.off("click", n), p.params.touchMove && (p.wrapper.off(i.touchEvents.start, e, k), p.wrapper.off(i.touchEvents.move, a, P), p.wrapper.off(i.touchEvents.end, t, k))
                }
                ...
                var t, n = !1;
                if (!a) return !1;
                if (Array.isArray(a)) for (t = 0; t < a.length; t++) a[t].from || a[t].to ? a[t].from && a[t].to ? e <= new Date(a[t].to).getTime() && e >= new Date(a[t].from).getTime() && (n = !0) : a[t].from ? e >= new Date(a[t].from).getTime() && (n = !0) : a[t].to && e <= new Date(a[t].to).getTime() && (n = !0) : e === new Date(a[t]).getTime() && (n = !0); else a.from || a.to ? a.from && a.to ? e <= new Date(a.to).getTime() && e >= new Date(a.from).getTime() && (n = !0) : a.from ? e >= new Date(a.from).getTime() && (n = !0) : a.to && e <= new Date(a.to).getTime() && (n = !0) : "function" == typeof a && (n = a(new Date(e)));
                return n
                ...
                var e = a(), t = !1;
                p.opened || (p.value || p.params.value && (p.value = p.params.value, t = !0), p.layout(), e ? (p.pickerHTML = '<div class="popover popover-picker-calendar"><div class="popover-inner">' + p.pickerHTML + "</div></div>", p.popover = i.popover(p.pickerHTML, p.params.input, !0), p.container = o(p.popover).find(".picker-modal"), o(p.popover).on("popover:close", function () {
                    l()
                })) : p.inline ? (p.container = o(p.pickerHTML), p.container.addClass("picker-modal-inline"), o(p.params.container).append(p.container)) : (p.container = o(i.pickerModal(p.pickerHTML)), o(p.container).on("picker:close", function () {
                    l()
        ...
        i.addNotification = function (e) {
            if (e) {
                "undefined" == typeof e.media && (e.media = i.params.notificationMedia), "undefined" == typeof e.title && (e.title = i.params.notificationTitle), "undefined" == typeof e.subtitle && (e.subtitle = i.params.notificationSubtitle), "undefined" == typeof e.closeIcon && (e.closeIcon = i.params.notificationCloseIcon), "undefined" == typeof e.hold && (e.hold = i.params.notificationHold), "undefined" == typeof e.closeOnClick && (e.closeOnClick = i.params.notificationCloseOnClick), "undefined" == typeof e.button && (e.button = i.params.notificationCloseButtonText && {
                    ...
                    close: !0
                }), x || (x = document.createElement("div")), e.material = i.params.material;
                var a = o(".notifications");
                0 === a.length && (i.root.append('<div class="notifications list-block' + (e.material ? "" : " media-list") + '"><ul></ul></div>'), a = o(".notifications"));
                var t = a.children("ul"),
                ...
                i._compiledTemplates.notification || (i._compiledTemplates.notification = l.compile(n)), x.innerHTML = i._compiledTemplates.notification(e);
                var r = o(x).children();
                r.on("click", function (a) {
                    var t = !1, n = o(a.target);
                    e.material && n.hasClass("button") && e.button && e.button.onClick && e.button.onClick.call(n[0], a, r[0]), n.is(".close-notification") || o(a.target).parents(".close-notification").length > 0 ? t = !0 : (e.onClick && e.onClick(a, r[0]), e.closeOnClick && (t = !0)), t && i.closeNotification(r[0], a)
                }), e.onClose && r.data("f7NotificationOnClose", function (a) {
                    e.onClose(r[0], a)
                }), e.additionalClass && r.addClass(e.additionalClass), e.hold && setTimeout(function () {
                    r.length > 0 && i.closeNotification(r[0])
                }, e.hold), i.params.material || i.closeNotification(t.children("li.notification-item:last-child")), t.append(r[0]), a.show();
                var s, p = r.outerHeight();
                return e.material ? (a.transform("translate3d(0, " + p + "px, 0)"), a.transition(0), s = r[0].clientLeft, a.transform("translate3d(0, 0, 0)"), a.transition("")) : (r.transform("translate3d(0," + -p + "px,0)"), r.transition(0), s = r[0].clientLeft, r.transition(""), r.transform("translate3d(0,0px,0)")), a.transform("translate3d(0, 0,0)"), r.removeClass("notification-hidden"), r[0]
            }
        }, i.closeNotification = function (e, a) {
            if (e = o(e), 0 !== e.length && !e.hasClass("notification-item-removing")) {
                var t = o(".notifications"), n = e.outerHeight();
                e.css("height", n + "px").transition(0).addClass("notification-item-removing");
                e[0].clientLeft;
                e.css({
                    height: "0px",
                    marginBottom: "0px"
            ...
            e = o(e);
            var t = e.find(".data-table-header"), n = e.find(".data-table-header-selected");
            e.on("change", '.checkbox-cell input[type="checkbox"]', function (t) {
                if (!t.detail || !t.detail._sentByF7DataTable) {
                    var n = o(this), r = n[0].checked;
                    n.parents("thead").length > 0 ? e.find("tbody tr")[r ? "addClass" : "removeClass"]("data-table-row-selected").find("input").prop("checked", r).trigger("change", {_sentByF7DataTable: !0}) : (n.parents("tr")[r ? "addClass" : "removeClass"]("data-table-row-selected"), r ? e.find('tbody .checkbox-cell input[type="checkbox"]:checked').length === e.find("tbody tr").length && e.find('thead .checkbox-cell input[type="checkbox"]').prop("checked", !0).trigger("change", {_sentByF7DataTable: !0}) : e.find('thead .checkbox-cell input[type="checkbox"]').prop("checked", !1)), a()
                }
            }), a(), e.find("thead .sortable-cell").on("click", function () {
                var a, t = o(this), n = t.hasClass("sortable-active");
                n ? (a = t.hasClass("sortable-desc") ? "desc" : "asc", t.removeClass("sortable-desc sortable-asc").addClass("sortable-" + ("desc" === a ? "asc" : "desc"))) : (e.find("thead .sortable-active").removeClass("sortable-active"), t.addClass("sortable-active"))
            }), e.hasClass("data-table-collapsible") && e.find("tbody td:not(.checkbox-cell)").each(function () {
                var a = o(this).index(), t = o(this).attr("data-collapsible-title");
                t || "" === t || o(this).attr("data-collapsible-title", e.find("thead th").eq(a).text())
            })
        }, i.initPageDataTables = function (e) {
            e = o(e);
            var a = e.find(".data-table-init");
            0 === a.length && e.hasClass("data-table-init") && (a = e), a.each(function () {
                i.initDataTable(this)
            })
        ...
        return i.initPlugins = function () {
            ...
            for (var a = 0; a < T.length; a++) T[a].hooks && e in T[a].hooks && T[a].hooks[e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5])
        }, i.pluginPrevent = function (e) {
            for (var a = !1, t = 0; t < T.length; t++) T[t].prevents && e in T[t].prevents && T[t].prevents[e](arguments[1], arguments[2], arguments[3], arguments[4], arguments[5]) && (a = !0);
            return a
        }, i.pluginProcess = function (e, a) {
            for (var t = a, n = 0; n < T.length; n++) T[n].preprocess && e in T[n].preprocess && (t = T[n].preprocess[e](a, arguments[2], arguments[3], arguments[4], arguments[5], arguments[6]));
            return t
        }, i.init = function () {
            i.initTemplate7Templates && i.initTemplate7Templates(), i.initPlugins && i.initPlugins(), i.getDeviceInfo && i.getDeviceInfo(), i.initResize && i.initResize(), i.initPanelsBreakpoints && (i.params.panelLeftBreakpoint || i.params.panelRightBreakpoint) && i.initPanelsBreakpoints(), i.initFastClicks && i.params.fastClicks && i.initFastClicks(), i.initClickEvents && i.initClickEvents(), o(".page:not(.cached)").each(function () {
                i.initPageWithCallback(this)
            }), o(".navbar:not(.cached)").each(function () {
                i.initNavbarWithCallback(this)
            }), i.initPushState && i.params.pushState && i.initPushState(), i.initSwipeout && i.params.swipeout && i.initSwipeout(), i.initSortable && i.params.sortable && i.initSortable(), i.initSwipePanels && (i.params.swipePanel || i.params.swipePanelOnlyClose) && i.initSwipePanels(), i.params.material && i.initMaterialWatchInputs && i.initMaterialWatchInputs(), i.params.material && o(".tabbar").each(function (e, a) {
                0 === o(a).parents(".page").length && i.initMaterialTabbar(a)
    ...
    var e = function () {
            ...
            addClass: function (e) {
                ...
                var t;
                {
                    if ("undefined" != typeof a) {
                        for (var n = 0; n < this.length; n++) t = this[n], t.dom7ElementDataStorage || (t.dom7ElementDataStorage = {}), t.dom7ElementDataStorage[e] = a;
                        return this
                    }
                    if (t = this[0]) {
                ...
                var t, n = ["webkitAnimationEnd", "animationend"], r = this;
                if (e) for (t = 0; t < n.length; t++) r.on(n[t], a);
                return this
            }, width: function () {
                ...
                if (!e) return this;
                for (var a = 0; a < this.length; a++) if (e.call(this[a], a, this[a]) === !1) return this;
                return this
            }, filter: function (a) {
                ...
                if ("string" == typeof t) {
                    ...
                    for (n = a(t), r = 0; r < n.length; r++) if (n[r] === i) return !0;
                    return !1
                }
                if (t === document) return i === document;
                if (t === window) return i === window;
                if (t.nodeType || t instanceof e) {
                    for (n = t.nodeType ? [t] : t, r = 0; r < n.length; r++) if (n[r] === i) return !0;
                    return !1
                }
                return !1
            }, indexOf: function (e) {
                ...
                var t, n = this.length;
                return a > n - 1 ? new e([]) : a < 0 ? (t = n + a, new e(t < 0 ? [] : [this[t]])) : new e([this[a]])
            }, append: function () {
                var a, t, n, r;
                for (n = 0; n < arguments.length; n++) for (r = arguments[n], a = 0; a < this.length; a++) if ("string" == typeof r) {
                    var i = document.createElement("div");
                    for (i.innerHTML = r; i.firstChild;) this[a].appendChild(i.firstChild)
                } else if (r instanceof e) for (t = 0; t < r.length; t++) this[a].appendChild(r[t]); else this[a].appendChild(r);
                return this
            }, appendTo: function (e) {
                ...
                if (this.length > 0) {
                    var n = this[0];
                    return new e(t ? n.previousElementSibling && a(n.previousElementSibling).is(t) ? [n.previousElementSibling] : [] : n.previousElementSibling ? [n.previousElementSibling] : [])
                }
                return new e([])
            }, prevAll: function (t) {
                var n = [], r = this[0];
                ...
                for (var e = 0; e < this.length; e++) {
                    var a = this[e];
                    if (1 === a.nodeType) {
                        for (var t = 0; t < a.childNodes.length; t++) a.childNodes[t].parentNode && a.childNodes[t].parentNode.removeChild(a.childNodes[t]);
                        a.textContent = ""
                    }
                }
                return this
        ...
        a.ajax = function (e) {
            ...
            if ("json" === e.dataType && e.url.indexOf("callback=") >= 0) {
                ...
                return h.type = "text/javascript", h.onerror = function () {
                    clearTimeout(d), r(void 0, void 0, "error", null, "scripterror"), r("ajaxComplete ajax:complete", {scripterror: !0}, "complete", null, "scripterror")
            ...
            return g.onload = function (a) {
                if (T && clearTimeout(T), g.status >= 200 && g.status < 300 || 0 === g.status) {
                    ...
                    if ("json" === e.dataType) try {
                        n = JSON.parse(g.responseText), r("ajaxSuccess ajax:success", {xhr: g}, "success", n, g.status, g)
                    } catch (e) {
                        r("ajaxError ajax:error", {xhr: g, parseerror: !0}, "error", g, "parseerror")
                    } else n = "text" === g.responseType || "" === g.responseType ? g.responseText : g.response,
                        r("ajaxSuccess ajax:success", {xhr: g}, "success", n, g.status, g)
                } else r("ajaxError ajax:error", {xhr: g}, "error", g, g.status);
                e.statusCode && (t.statusCode && t.statusCode[g.status] && t.statusCode[g.status](g), e.statusCode[g.status] && e.statusCode[g.status](g)), r("ajaxComplete ajax:complete", {xhr: g}, "complete", g, g.status)
            }, g.onerror = function (e) {
                T && clearTimeout(T), r("ajaxError ajax:error", {xhr: g}, "error", g, g.status), r("ajaxComplete ajax:complete", {
                    xhr: g,
                    error: !0
                }, "complete", g, "error")
            }, r("ajaxStart ajax:start", {xhr: g}, "start", g), r(void 0, void 0, "beforeSend", g), e.timeout > 0 && (g.onabort = function () {
                T && clearTimeout(T)
            }, T = setTimeout(function () {
                g.abort(), r("ajaxError ajax:error", {
                    xhr: g,
                    timeout: !0
                }, "error", g, "timeout"), r("ajaxComplete ajax:complete", {
                    xhr: g,
                    timeout: !0
                }, "complete", g, "timeout")
            ...
            e = e || location.href;
            var a, t, n, r, i = {};
            if ("string" == typeof e && e.length) for (e = e.indexOf("?") > -1 ? e.replace(/\S*\?/, "") : "", t = e.split("&"), r = t.length, a = 0; a < r; a++) n = t[a].replace(/#\S+/g, "").split("="), i[decodeURIComponent(n[0])] = decodeURIComponent(n[1]) || "";
            return i
        }, a.isArray = function (e) {
            return Array.isArray(e)
        }, a.each = function (a, t) {
            if ("object" == typeof a && t) if (Array.isArray(a) || a instanceof e) {
                var n;
                for (n = 0; n < a.length; n++) if (t(n, a[n]) === !1) return
            } else {
                var r;
                for (r in a) if (a.hasOwnProperty(r) && t(r, a[r]) === !1) return
            }
        }, a.unique = function (e) {
            ...
            for (var l in e) if (e.hasOwnProperty(l)) {
                ...
                if (Array.isArray(e[l])) {
                    p = [];
                    for (var d = 0; d < e[l].length; d++) Array.isArray(e[l][d]) || "object" != typeof e[l][d] ? p.push(n(l) + "[]=" + r(e[l][d])) : (o = t.slice(), o.push(l), o.push(d + ""), p.push(a.serializeObject(e[l][d], o)));
                    p.length > 0 && i.push(p.join(s))
                } else null === e[l] ? i.push(n(l) + "=") : "object" == typeof e[l] ? (o = t.slice(), o.push(l), p = a.serializeObject(e[l], o), "" !== p && i.push(p)) : "undefined" != typeof e[l] && "" !== e[l] ? i.push(n(l) + "=" + r(e[l])) : "" === e[l] && i.push(n(l))
            }
            return i.join(s)
            ...
            return "undefined" == typeof a && (a = "x"), r = window.getComputedStyle(e, null), window.WebKitCSSMatrix ? (n = r.transform || r.webkitTransform, n.split(",").length > 6 && (n = n.split(", ").map(function (e) {
                return e.replace(",", ".")
            }).join(", ")), i = new WebKitCSSMatrix("none" === n ? "" : n)) : (i = r.transform || r.getPropertyValue("transform").replace("translate(", "matrix(1, 0, 0, 1,"), t = i.toString().split(",")), "x" === a && (n = window.WebKitCSSMatrix ? i.m41 : 16 === t.length ? parseFloat(t[12]) : parseFloat(t[4])), "y" === a && (n = window.WebKitCSSMatrix ? i.m42 : 16 === t.length ? parseFloat(t[13]) : parseFloat(t[5])), n || 0
        ...
        for (var r = [{base: "A", letters: "AⒶＡÀÁÂẦẤẪẨÃĀĂẰẮẴẲȦǠÄǞẢÅǺǍȀȂẠẬẶḀĄȺⱯ"}, {
            base: "AA",
            letters: "Ꜳ"
        ...
        }], i = {}, s = 0; s < r.length; s++) for (var o = r[s].letters, l = 0; l < o.length; l++) i[o[l]] = r[s].base;
        return a.removeDiacritics = function (e) {
            return e.replace(/[^\u0000-\u007E]/g, function (e) {
                return i[e] || e
            })
        }, a.fn = e.prototype, a.fn.scrollTo = function (e, t, n, r, i) {
            return 4 === arguments.length && "function" == typeof r && (i = r, r = void 0), this.each(function () {
                function s(e) {
                    ...
                    return g && (m = o + d * (c - o)), v && (f = l + d * (u - l)), g && c > o && m >= c && (h.scrollTop = c, t = !0), g && c < o && m <= c && (h.scrollTop = c, t = !0), v && u > l && f >= u && (h.scrollLeft = u, t = !0), v && u < l && f <= u && (h.scrollLeft = u, t = !0), t ? void(i && i()) : (g && (h.scrollTop = m), v && (h.scrollLeft = f), void a.requestAnimationFrame(s))
                }
    ...
    var t = function (e, t, n) {
        ...
        var s = this;
        if (s.params = n, s.props = t, s.elements = a(e), 0 === s.elements.length) return s;
        s.easingProgress = function (e, a) {
        ...
        }, s.animating = !1, s.que = [], s.animate = function (t, n) {
            function r() {
                o = (new Date).getTime();
                var m, f, h;
                u || (u = !0, n.begin && n.begin(e)), null === p && (p = o), n.progress && n.progress(s.elements, Math.max(Math.min((o - p) / n.duration, 1), 0), p + n.duration - o < 0 ? 0 : p + n.duration - o, p);
                for (var g = 0; g < i.length; g++) if (!l && (h = i[g], !h.done)) for (var v in t) {
                    if (m = Math.max(Math.min((o - p) / n.duration, 1), 0), f = s.easingProgress(n.easing, m), h[v].currentValue = h[v].initialValue + f * (h[v].finalValue - h[v].initialValue), (h[v].finalValue > h[v].initialValue && h[v].currentValue >= h[v].finalValue || h[v].finalValue < h[v].initialValue && h[v].currentValue <= h[v].finalValue) && (h._container.style[v] = h[v].finalValue + h[v].unit, c++, c === Object.keys(t).length && (h.done = !0, d++), d === i.length && (l = !0)), l) return s.done(n.complete), s;
            ...
            s.elements.each(function (e, a) {
                var n, r, s, o, l;
                i[e] = {_container: a};
                for (var p in t) n = window.getComputedStyle(a, null).getPropertyValue(p).replace(",", "."), r = parseFloat(n), s = n.replace(r, ""), o = t[p], l = t[p] + s, i[e][p] = {
                    initialFullValue: n,
                    initialValue: r,
                    unit: s,
                    finalValue: o,
            ...
            var o, l, p = null, d = 0, c = 0, u = !1;
            return s.animating = !0, s.frameId = a.requestAnimationFrame(r), s
        };
        for (var o, l = 0; l < s.elements.length; l++) s.elements[l].animate7Instance ? o = s.elements[l].animate7Instance : s.elements[l].animate7Instance = s;
    ...
    window.Animate7 = function (e, a, n) {
        ...
        var a = {}, t = navigator.userAgent, n = e, r = t.match(/(Windows Phone);?[\s\/]+([\d.]+)?/),
            i = t.match(/(Android);?[\s\/]+([\d.]+)?/), s = t.match(/(iPad).*OS\s([\d_]+)/),
            o = t.match(/(iPod)(.*OS\s([\d_]+))?/), l = !s && t.match(/(iPhone\sOS|iOS)\s([\d_]+)/);
        if (a.ios = a.android = a.windows = a.iphone = a.ipod = a.ipad = a.androidChrome = !1, r && (a.os = "windows", a.osVersion = r[2], a.windows = !0), i && !r && (a.os = "android", a.osVersion = i[2], a.android = !0, a.androidChrome = t.toLowerCase().indexOf("chrome") >= 0), (s || l || o) && (a.os = "ios", a.ios = !0), l && !o && (a.osVersion = l[2].replace(/_/g, "."), a.iphone = !0), s && (a.osVersion = s[2].replace(/_/g, "."), a.ipad = !0), o && (a.osVersion = o[3] ? o[3].replace(/_/g, ".") : null, a.iphone = !0), a.ios && a.osVersion && t.indexOf("Version/") >= 0 && "10" === a.osVersion.split(".")[0] && (a.osVersion = t.toLowerCase().split("version/")[1].split(" ")[0]), a.webView = (l || s || o) && t.match(/.*AppleWebKit(?!.*Safari)/i), a.os && "ios" === a.os) {
            var p = a.osVersion.split(".");
            a.minimalUi = !a.webView && (o || l) && (1 * p[0] === 7 ? 1 * p[1] >= 1 : 1 * p[0] > 7) && n('meta[name="viewport"]').length > 0 && n('meta[name="viewport"]').attr("content").indexOf("minimal-ui") >= 0
        }
        var d = n(window).width(), c = n(window).height();
        a.needsStatusBar = function () {
            return !(!a.webView || d * c !== screen.width * screen.height)
        }, a.statusBar = a.needsStatusBar();
        var u = [];
        if (a.pixelRatio = window.devicePixelRatio || 1, u.push("pixel-ratio-" + Math.floor(a.pixelRatio)), a.pixelRatio >= 2 && u.push("retina"), a.os && (u.push(a.os, a.os + "-" + a.osVersion.split(".")[0], a.os + "-" + a.osVersion.replace(/\./g, "-")), "ios" === a.os)) for (var m = parseInt(a.osVersion.split(".")[0], 10), f = m - 1; f >= 6; f--) u.push("ios-gt-" + f);
        return a.statusBar ? u.push("with-statusbar-overlay") : n("html").removeClass("with-statusbar-overlay"), u.length > 0 && n("html").addClass(u.join(" ")), a
        ...
        function n(e) {
            ...
            for (t = 0; t < r.length; t++) {
                var l, p, d = r[t];
                if (0 === t) o.push(d); else if (0 === d.indexOf('"') || 0 === d.indexOf("'")) if (l = 0 === d.indexOf('"') ? s : i, p = 0 === d.indexOf('"') ? '"' : "'", 2 === d.match(l).length) o.push(d); else {
                    for (a = 0, n = t + 1; n < r.length; n++) if (d += " " + r[n], r[n].indexOf(p) >= 0) {
                        a = n, o.push(d);
                        break
                    }
                    a && (t = a)
                } else if (d.indexOf("=") > 0) {
                    var c = d.split("="), u = c[0], m = c[1];
                    if (l || (l = 0 === m.indexOf('"') ? s : i, p = 0 === m.indexOf('"') ? '"' : "'"), 2 !== m.match(l).length) {
                        for (a = 0, n = t + 1; n < r.length; n++) if (m += " " + r[n], r[n].indexOf(p) >= 0) {
                            a = n;
                            break
                        }
                        a && (t = a)
            ...
            for (t = 0; t < s.length; t++) {
                ...
                if ("" !== o) if (o.indexOf("{{") < 0) i.push({type: "plain", content: o}); else {
                    ...
                    if (o.indexOf("{#") >= 0) {
                        ...
                        for (r = t + 1; r < s.length; r++) if (s[r].indexOf("{{#") >= 0 && C++, s[r].indexOf("{{/") >= 0 && C--, s[r].indexOf("{{#" + p) >= 0) h += s[r], w && (g += s[r]), v++; else if (s[r].indexOf("{{/" + p) >= 0) {
                            if (!(v > 0)) {
                                f = r, b = !0;
                                break
                            }
        ...
        var i = new RegExp("'", "g"), s = new RegExp('"', "g"), o = function (e, a) {
            function t(e, a) {
            ...
            function i(e, a) {
                ...
                for (var s = 0; s < n.length; s++) {
                    var o = n[s];
                    0 === o.indexOf("@") ? s > 0 ? t += "[(data && data." + o.replace("@", "") + ")]" : t = "(data && data." + e.replace("@", "") + ")" : isFinite(o) ? t += "[" + o + "]" : "this" === o || o.indexOf("this.") >= 0 || o.indexOf("this[") >= 0 || o.indexOf("this(") >= 0 ? t = o.replace("this", a) : t += "." + o
                }
                return t
            }

            function s(e, a) {
                for (var t = [], n = 0; n < e.length; n++) /^['"]/.test(e[n]) ? t.push(e[n]) : /^(true|false|\d+)$/.test(e[n]) ? t.push(e[n]) : t.push(i(e[n], a));
                return t.join(", ")
            }

            function o(e, a) {
                if (a = a || 1, e = e || l.template, "string" != typeof e) throw new Error("Template7: Template must be a string");
                var o = r(e);
                ...
                for (c = 0; c < o.length; c++) {
                    ...
                    if ("plain" !== u.type) {
                        var m, f;
                        if ("variable" === u.type && (m = i(u.contextName, p), d += "r += c(" + m + ", " + p + ");"), "helper" === u.type) if (u.helperName in l.helpers) f = s(u.contextName, p), d += "r += (Template7.helpers." + u.helperName + ").call(" + p + ", " + (f && f + ", ") + "{hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + t(u, a + 1) + ", inverse: " + n(u, a + 1) + ", root: root});"; else {
                            if (u.contextName.length > 0) throw new Error('Template7: Missing helper: "' + u.helperName + '"');
                            m = i(u.helperName, p), d += "if (" + m + ") {", d += "if (isArray(" + m + ")) {", d += "r += (Template7.helpers.each).call(" + p + ", " + m + ", {hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + t(u, a + 1) + ", inverse: " + n(u, a + 1) + ", root: root});", d += "}else {", d += "r += (Template7.helpers.with).call(" + p + ", " + m + ", {hash:" + JSON.stringify(u.hash) + ", data: data || {}, fn: " + t(u, a + 1) + ", inverse: " + n(u, a + 1) + ", root: root});", d += "}}"
                        }
        ...
        function i() {
            var e = v.params.autoplay, a = v.slides.eq(v.activeIndex);
            a.attr("data-swiper-autoplay") && (e = a.attr("data-swiper-autoplay") || v.params.autoplay), v.autoplayTimeoutId = setTimeout(function () {
        ...
        n = n || {};
        var u = {};
        for (var m in n) if ("object" != typeof n[m] || null === n[m] || (n[m].nodeType || n[m] === window || n[m] === document || "undefined" != typeof e && n[m] instanceof e || "undefined" != typeof jQuery && n[m] instanceof jQuery)) u[m] = n[m]; else {
            u[m] = {};
            for (var f in n[m]) u[m][f] = n[m][f]
        }
        for (var h in d) if ("undefined" == typeof n[h]) n[h] = d[h]; else if ("object" == typeof n[h]) for (var g in d[h]) "undefined" == typeof n[h][g] && (n[h][g] = d[h][g]);
        var v = this;
        if (v.params = n, v.originalParams = u, v.classNames = [], "undefined" != typeof a && "undefined" != typeof e && (a = e), ("undefined" != typeof a || (a = "undefined" == typeof e ? window.Dom7 || window.Zepto || window.jQuery : e)) && (v.$ = a, v.currentBreakpoint = void 0, v.getActiveBreakpoint = function () {
            ...
            v.container[0].swiper = v, v.container.data("swiper", v), v.classNames.push(v.params.containerModifierClass + v.params.direction), v.params.freeMode && v.classNames.push(v.params.containerModifierClass + "free-mode"), v.support.flexbox || (v.classNames.push(v.params.containerModifierClass + "no-flexbox"), v.params.slidesPerColumn = 1), v.params.autoHeight && v.classNames.push(v.params.containerModifierClass + "autoheight"), (v.params.parallax || v.params.watchSlidesVisibility) && (v.params.watchSlidesProgress = !0), v.params.touchReleaseOnEdges && (v.params.resistanceRatio = 0), ["cube", "coverflow", "flip"].indexOf(v.params.effect) >= 0 && (v.support.transforms3d ? (v.params.watchSlidesProgress = !0, v.classNames.push(v.params.containerModifierClass + "3d")) : v.params.effect = "slide"), "slide" !== v.params.effect && v.classNames.push(v.params.containerModifierClass + v.params.effect), "cube" === v.params.effect && (v.params.resistanceRatio = 0, v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.centeredSlides = !1, v.params.spaceBetween = 0, v.params.virtualTranslate = !0), "fade" !== v.params.effect && "flip" !== v.params.effect || (v.params.slidesPerView = 1, v.params.slidesPerColumn = 1, v.params.slidesPerGroup = 1, v.params.watchSlidesProgress = !0, v.params.spaceBetween = 0, "undefined" == typeof c && (v.params.virtualTranslate = !0)), v.params.grabCursor && v.support.touch && (v.params.grabCursor = !1), v.wrapper = v.container.children("." + v.params.wrapperClass), v.params.pagination && (v.paginationContainer = a(v.params.pagination), v.params.uniqueNavElements && "string" == typeof v.params.pagination && v.paginationContainer.length > 1 && 1 === v.container.find(v.params.pagination).length && (v.paginationContainer = v.container.find(v.params.pagination)), "bullets" === v.params.paginationType && v.params.paginationClickable ? v.paginationContainer.addClass(v.params.paginationModifierClass + "clickable") : v.params.paginationClickable = !1, v.paginationContainer.addClass(v.params.paginationModifierClass + v.params.paginationType)), (v.params.nextButton || v.params.prevButton) && (v.params.nextButton && (v.nextButton = a(v.params.nextButton), v.params.uniqueNavElements && "string" == typeof v.params.nextButton && v.nextButton.length > 1 && 1 === v.container.find(v.params.nextButton).length && (v.nextButton = v.container.find(v.params.nextButton))), v.params.prevButton && (v.prevButton = a(v.params.prevButton), v.params.uniqueNavElements && "string" == typeof v.params.prevButton && v.prevButton.length > 1 && 1 === v.container.find(v.params.prevButton).length && (v.prevButton = v.container.find(v.params.prevButton)))), v.isHorizontal = function () {
                ...
                v.params.allowSwipeToNext = !1, v.params.allowSwipeToPrev === !1 && v.params.grabCursor && v.unsetGrabCursor()
            }, v.lockSwipeToPrev = function () {
                v.params.allowSwipeToPrev = !1, v.params.allowSwipeToNext === !1 && v.params.grabCursor && v.unsetGrabCursor()
                ...
                v.params.allowSwipeToNext = !0, v.params.allowSwipeToPrev === !0 && v.params.grabCursor && v.setGrabCursor()
            }, v.unlockSwipeToPrev = function () {
                v.params.allowSwipeToPrev = !0, v.params.allowSwipeToNext === !0 && v.params.grabCursor && v.setGrabCursor()
            ...
            }, v.params.grabCursor && v.setGrabCursor(), v.imagesToLoad = [], v.imagesLoaded = 0, v.loadImage = function (e, a, t, n, r, i) {
                function s() {
                    i && i()
                }

                var o;
                e.complete && r ? s() : a ? (o = new window.Image, o.onload = s, o.onerror = s, n && (o.sizes = n), t && (o.srcset = t), a && (o.src = a)) : s()
            }, v.preloadImages = function () {
                function e() {
                    "undefined" != typeof v && null !== v && v && (void 0 !== v.imagesLoaded && v.imagesLoaded++, v.imagesLoaded === v.imagesToLoad.length && (v.params.updateOnImagesReady && v.update(), v.emit("onImagesReady", v)))
                }

                v.imagesToLoad = v.container.find("img");
                for (var a = 0; a < v.imagesToLoad.length; a++) v.loadImage(v.imagesToLoad[a], v.imagesToLoad[a].currentSrc || v.imagesToLoad[a].getAttribute("src"), v.imagesToLoad[a].srcset || v.imagesToLoad[a].getAttribute("srcset"), v.imagesToLoad[a].sizes || v.imagesToLoad[a].getAttribute("sizes"), !0, e)
            }, v.autoplayTimeoutId = void 0, v.autoplaying = !1, v.autoplayPaused = !1, v.startAutoplay = function () {
                return "undefined" == typeof v.autoplayTimeoutId && (!!v.params.autoplay && (!v.autoplaying && (v.autoplaying = !0, v.emit("onAutoplayStart", v), void i())))
                ...
                var e, a = [], t = 0;
                if ("auto" !== v.params.slidesPerView && v.params.slidesPerView > 1) for (e = 0; e < Math.ceil(v.params.slidesPerView); e++) {
                ...
                var e, a = v.params.spaceBetween, t = -v.params.slidesOffsetBefore, n = 0, i = 0;
                if ("undefined" != typeof v.size) {
                    ...
                    var o, l = v.params.slidesPerColumn, p = s / l,
                    ...
                    for (e = 0; e < v.slides.length; e++) {
                        ...
                        if (v.params.slidesPerColumn > 1) {
                            ...
                            "column" === v.params.slidesPerColumnFill ? (m = Math.floor(e / l), f = e - m * l, (m > d || m === d && f === l - 1) && ++f >= l && (f = 0, m++), u = m + f * s / l, c.css({
                                ...
                                "-webkit-order": u,
                                order: u
                            })) : (f = Math.floor(e / p), m = e - f * p), c.css("margin-" + (v.isHorizontal() ? "top" : "left"), 0 !== f && v.params.spaceBetween && v.params.spaceBetween + "px").attr("data-swiper-column", m).attr("data-swiper-row", f)
                        }
                        "none" !== c.css("display") && ("auto" === v.params.slidesPerView ? (o = v.isHorizontal() ? c.outerWidth(!0) : c.outerHeight(!0), v.params.roundLengths && (o = r(o))) : (o = (v.size - (v.params.slidesPerView - 1) * a) / v.params.slidesPerView, v.params.roundLengths && (o = r(o)), v.isHorizontal() ? v.slides[e].style.width = o + "px" : v.slides[e].style.height = o + "px"), v.slides[e].swiperSlideSize = o, v.slidesSizesGrid.push(o), v.params.centeredSlides ? (t = t + o / 2 + n / 2 + a, 0 === n && 0 !== e && (t = t - v.size / 2 - a), 0 === e && (t = t - v.size / 2 - a), Math.abs(t) < .001 && (t = 0), i % v.params.slidesPerGroup === 0 && v.snapGrid.push(t), v.slidesGrid.push(t)) : (i % v.params.slidesPerGroup === 0 && v.snapGrid.push(t), v.slidesGrid.push(t), t = t + o + a), v.virtualSize += o + a, n = o, i++)
                    }
                ...
                var e, a, t = 1;
                if (v.params.centeredSlides) {
                    var n, r = v.slides[v.activeIndex].swiperSlideSize;
                    for (e = v.activeIndex + 1; e < v.slides.length; e++) v.slides[e] && !n && (r += v.slides[e].swiperSlideSize, t++, r > v.size && (n = !0));
                    for (a = v.activeIndex - 1; a >= 0; a--) v.slides[a] && !n && (r += v.slides[a].swiperSlideSize, t++, r > v.size && (n = !0))
                } else for (e = v.activeIndex + 1; e < v.slides.length; e++) v.slidesGrid[e] - v.slidesGrid[v.activeIndex] < v.size && t++;
                return t
                ...
                if ("undefined" == typeof e && (e = v.translate || 0), 0 !== v.slides.length) {
                    ...
                    for (var t = 0; t < v.slides.length; t++) {
                        var n = v.slides[t],
                            r = (a + (v.params.centeredSlides ? v.minTranslate() : 0) - n.swiperSlideOffset) / (n.swiperSlideSize + v.params.spaceBetween);
                        if (v.params.watchSlidesVisibility) {
                            var i = -(a - n.swiperSlideOffset), s = i + v.slidesSizesGrid[t],
                                o = i >= 0 && i < v.size || s > 0 && s <= v.size || i <= 0 && s >= v.size;
                ...
                var a = v.maxTranslate() - v.minTranslate(), t = v.isBeginning, n = v.isEnd;
                ...
                v.params.normalizeSlideIndex && (e < 0 || "undefined" == typeof e) && (e = 0), t = Math.floor(e / v.params.slidesPerGroup), t >= v.snapGrid.length && (t = v.snapGrid.length - 1), e !== v.activeIndex && (v.snapIndex = t, v.previousIndex = v.activeIndex, v.activeIndex = e, v.updateClasses(), v.updateRealIndex())
                ...
                if (v.params.pagination && v.paginationContainer && v.paginationContainer.length > 0) {
                    ...
                    if ("bullets" === v.params.paginationType) {
                        for (var a = v.params.loop ? Math.ceil((v.slides.length - 2 * v.loopedSlides) / v.params.slidesPerGroup) : v.snapGrid.length, t = 0; t < a; t++) e += v.params.paginationBulletRender ? v.params.paginationBulletRender(v, t, v.params.bulletClass) : "<" + v.params.paginationElement + ' class="' + v.params.bulletClass + '"></' + v.params.paginationElement + ">";
                ...
                function a() {
                    ...
                    t = Math.min(Math.max(v.translate, v.maxTranslate()), v.minTranslate()), v.setWrapperTranslate(t), v.updateActiveIndex(), v.updateClasses()
                }

                if (v) {
                    v.updateContainerSize(), v.updateSlidesSize(), v.updateProgress(), v.updatePagination(), v.updateClasses(), v.params.scrollbar && v.scrollbar && v.scrollbar.set();
                    var t;
                    if (e) {
                        var n;
                        v.controller && v.controller.spline && (v.controller.spline = void 0), v.params.freeMode ? (a(), v.params.autoHeight && v.updateAutoHeight()) : (n = ("auto" === v.params.slidesPerView || v.params.slidesPerView > 1) && v.isEnd && !v.params.centeredSlides ? v.slideTo(v.slides.length - 1, 0, !1, !0) : v.slideTo(v.activeIndex, 0, !1, !0), n || a())
                ...
                v.params.lazyLoading && !n && v.lazy && v.lazy.load(), v.params.allowSwipeToPrev = a, v.params.allowSwipeToNext = t, v.params.onAfterResize && v.params.onAfterResize(v)
                ...
                var a = e ? "off" : "on", t = e ? "removeEventListener" : "addEventListener",
                    ...
                    i = v.support.touch ? r : document, s = !!v.params.nested;
                if (v.browser.ie) r[t](v.touchEvents.start, v.onTouchStart, !1), i[t](v.touchEvents.move, v.onTouchMove, s), i[t](v.touchEvents.end, v.onTouchEnd, !1); else {
                    if (v.support.touch) {
                        var o = !("touchstart" !== v.touchEvents.start || !v.support.passiveListener || !v.params.passiveListeners) && {
                            passive: !0,
                            capture: !1
                        };
                        r[t](v.touchEvents.start, v.onTouchStart, o), r[t](v.touchEvents.move, v.onTouchMove, s), r[t](v.touchEvents.end, v.onTouchEnd, o)
                    }
                    (n.simulateTouch && !v.device.ios && !v.device.android || n.simulateTouch && !v.support.touch && v.device.ios) && (r[t]("mousedown", v.onTouchStart, !1), document[t]("mousemove", v.onTouchMove, s), document[t]("mouseup", v.onTouchEnd, !1))
                }
                ...
                var t = s(e, "." + v.params.slideClass), n = !1;
                if (t) for (var r = 0; r < v.slides.length; r++) v.slides[r] === t && (n = !0);
                ...
                if (v.clickedSlide = t, v.clickedIndex = a(t).index(), v.params.slideToClickedSlide && void 0 !== v.clickedIndex && v.clickedIndex !== v.activeIndex) {
                    ...
                    if (v.params.loop) {
                        ...
                        i = parseInt(a(v.clickedSlide).attr("data-swiper-slide-index"), 10), v.params.centeredSlides ? o < v.loopedSlides - l / 2 || o > v.slides.length - v.loopedSlides + l / 2 ? (v.fixLoop(), o = v.wrapper.children("." + v.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.' + v.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function () {
                            v.slideTo(o)
                        }, 0)) : v.slideTo(o) : o > v.slides.length - l ? (v.fixLoop(), o = v.wrapper.children("." + v.params.slideClass + '[data-swiper-slide-index="' + i + '"]:not(.' + v.params.slideDuplicateClass + ")").eq(0).index(), setTimeout(function () {
                            v.slideTo(o)
                        }, 0)) : v.slideTo(o)
                    } else v.slideTo(o)
                }
            };
            var w, C, y, x, T, k, P, S, M, I, E = "input, select, textarea, button, video", O = Date.now(), z = [];
            ...
            v.onTouchStart = function (e) {
                if (e.originalEvent && (e = e.originalEvent), D = "touchstart" === e.type, D || !("which" in e) || 3 !== e.which) {
                    ...
                    if (!v.params.swipeHandler || s(e, v.params.swipeHandler)) {
                        ...
                        if (!(v.device.ios && v.params.iOSEdgeSwipeDetection && t <= v.params.iOSEdgeSwipeThreshold)) {
                            if (w = !0, C = !1, y = !0, T = void 0, L = void 0, v.touches.startX = t, v.touches.startY = n, x = Date.now(), v.allowClick = !0, v.updateContainerSize(), v.swipeDirection = void 0, v.params.threshold > 0 && (S = !1), "touchstart" !== e.type) {
                                var r = !0;
                ...
                if (e.originalEvent && (e = e.originalEvent), !D || "mousemove" !== e.type) {
                    ...
                    if (v.params.onlyExternal) return v.allowClick = !1, void(w && (v.touches.startX = v.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, v.touches.startY = v.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, x = Date.now()));
                    if (D && v.params.touchReleaseOnEdges && !v.params.loop) if (v.isHorizontal()) {
                    ...
                    } else if (v.touches.currentY < v.touches.startY && v.translate <= v.maxTranslate() || v.touches.currentY > v.touches.startY && v.translate >= v.minTranslate()) return;
                    if (D && document.activeElement && e.target === document.activeElement && a(e.target).is(E)) return C = !0, void(v.allowClick = !1);
                    if (y && v.emit("onTouchMove", v, e), !(e.targetTouches && e.targetTouches.length > 1)) {
                        if (v.touches.currentX = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, v.touches.currentY = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, "undefined" == typeof T) {
                            var t;
                            v.isHorizontal() && v.touches.currentY === v.touches.startY || !v.isHorizontal() && v.touches.currentX === v.touches.startX ? T = !1 : (t = 180 * Math.atan2(Math.abs(v.touches.currentY - v.touches.startY), Math.abs(v.touches.currentX - v.touches.startX)) / Math.PI, T = v.isHorizontal() ? t > v.params.touchAngle : 90 - t > v.params.touchAngle)
                        }
                        if (T && v.emit("onTouchMoveOpposite", v, e), "undefined" == typeof L && (v.touches.currentX === v.touches.startX && v.touches.currentY === v.touches.startY || (L = !0)), w) {
                            if (T) return void(w = !1);
                            if (L) {
                                v.allowClick = !1, v.emit("onSliderMove", v, e), e.preventDefault(), v.params.touchMoveStopPropagation && !v.params.nested && e.stopPropagation(), C || (n.loop && v.fixLoop(), P = v.getWrapperTranslate(), v.setWrapperTransition(0), v.animating && v.wrapper.trigger("webkitTransitionEnd transitionend oTransitionEnd MSTransitionEnd msTransitionEnd"), v.params.autoplay && v.autoplaying && (v.params.autoplayDisableOnInteraction ? v.stopAutoplay() : v.pauseAutoplay()), I = !1, !v.params.grabCursor || v.params.allowSwipeToNext !== !0 && v.params.allowSwipeToPrev !== !0 || v.setGrabCursor(!0)), C = !0;
                                var r = v.touches.diff = v.isHorizontal() ? v.touches.currentX - v.touches.startX : v.touches.currentY - v.touches.startY;
                                r *= v.params.touchRatio, v.rtl && (r = -r), v.swipeDirection = r > 0 ? "prev" : "next", k = r + P;
                                var i = !0;
                                if (r > 0 && k > v.minTranslate() ? (i = !1, v.params.resistance && (k = v.minTranslate() - 1 + Math.pow(-v.minTranslate() + P + r, v.params.resistanceRatio))) : r < 0 && k < v.maxTranslate() && (i = !1, v.params.resistance && (k = v.maxTranslate() + 1 - Math.pow(v.maxTranslate() - P - r, v.params.resistanceRatio))), i && (e.preventedByNestedSwiper = !0), !v.params.allowSwipeToNext && "next" === v.swipeDirection && k < P && (k = P), !v.params.allowSwipeToPrev && "prev" === v.swipeDirection && k > P && (k = P), v.params.threshold > 0) {
                                    if (!(Math.abs(r) > v.params.threshold || S)) return void(k = P);
                                    if (!S) return S = !0, v.touches.startX = v.touches.currentX, v.touches.startY = v.touches.currentY, k = P, void(v.touches.diff = v.isHorizontal() ? v.touches.currentX - v.touches.startX : v.touches.currentY - v.touches.startY)
                                }
                                v.params.followFinger && ((v.params.freeMode || v.params.watchSlidesProgress) && v.updateActiveIndex(), v.params.freeMode && (0 === z.length && z.push({
                                    position: v.touches[v.isHorizontal() ? "startX" : "startY"],
                                    time: x
                                }), z.push({
                                    position: v.touches[v.isHorizontal() ? "currentX" : "currentY"],
                                    time: (new window.Date).getTime()
                                })), v.updateProgress(k), v.setWrapperTranslate(k))
                            }
                        }
                    }
                }
                ...
                if (e.originalEvent && (e = e.originalEvent), y && v.emit("onTouchEnd", v, e), y = !1, w) {
                    v.params.grabCursor && C && w && (v.params.allowSwipeToNext === !0 || v.params.allowSwipeToPrev === !0) && v.setGrabCursor(!1);
                    var t = Date.now(), n = t - x;
                    if (v.allowClick && (v.updateClickedSlide(e), v.emit("onTap", v, e), n < 300 && t - O > 300 && (M && clearTimeout(M), M = setTimeout(function () {
                        ...
                        }, 300)), n < 300 && t - O < 300 && (M && clearTimeout(M), v.emit("onDoubleTap", v, e))), O = Date.now(), setTimeout(function () {
                            v && (v.allowClick = !0)
                        }, 0), !w || !C || !v.swipeDirection || 0 === v.touches.diff || k === P) return void(w = C = !1);
                    w = C = !1;
                    var r;
                    if (r = v.params.followFinger ? v.rtl ? v.translate : -v.translate : -k, v.params.freeMode) {
                        ...
                        if (v.params.freeModeMomentum) {
                            if (z.length > 1) {
                                var i = z.pop(), s = z.pop(), o = i.position - s.position, l = i.time - s.time;
                            ...
                            v.velocity = v.velocity * v.params.freeModeMomentumVelocityRatio, z.length = 0;
                            ...
                            if (c < v.maxTranslate()) v.params.freeModeMomentumBounce ? (c + v.maxTranslate() < -f && (c = v.maxTranslate() - f), u = v.maxTranslate(), m = !0, I = !0) : c = v.maxTranslate(); else if (c > v.minTranslate()) v.params.freeModeMomentumBounce ? (c - v.minTranslate() > f && (c = v.minTranslate() + f), u = v.minTranslate(), m = !0, I = !0) : c = v.minTranslate(); else if (v.params.freeModeSticky) {
                                var h, g = 0;
                            ...
                            v.params.freeModeMomentumBounce && m ? (v.updateProgress(u), v.setWrapperTransition(p), v.setWrapperTranslate(c), v.onTransitionStart(), v.animating = !0, v.wrapper.transitionEnd(function () {
                                v && I && (v.emit("onMomentumBounce", v), v.setWrapperTransition(v.params.speed), v.setWrapperTranslate(u), v.wrapper.transitionEnd(function () {
                                    v && v.onTransitionEnd()
                                }))
                    ...
                    var b, T = 0, S = v.slidesSizesGrid[0];
                    for (b = 0; b < v.slidesGrid.length; b += v.params.slidesPerGroup) "undefined" != typeof v.slidesGrid[b + v.params.slidesPerGroup] ? r >= v.slidesGrid[b] && r < v.slidesGrid[b + v.params.slidesPerGroup] && (T = b, S = v.slidesGrid[b + v.params.slidesPerGroup] - v.slidesGrid[b]) : r >= v.slidesGrid[b] && (T = b, S = v.slidesGrid[v.slidesGrid.length - 1] - v.slidesGrid[v.slidesGrid.length - 2]);
                    var E = (r - v.slidesGrid[T]) / S;
                    if (n > v.params.longSwipesMs) {
                        if (!v.params.longSwipes) return void v.slideTo(v.activeIndex);
                        "next" === v.swipeDirection && (E >= v.params.longSwipesRatio ? v.slideTo(T + v.params.slidesPerGroup) : v.slideTo(T)), "prev" === v.swipeDirection && (E > 1 - v.params.longSwipesRatio ? v.slideTo(T + v.params.slidesPerGroup) : v.slideTo(T))
                    } else {
                ...
                "undefined" == typeof t && (t = !0), "undefined" == typeof e && (e = 0), e < 0 && (e = 0), v.snapIndex = Math.floor(e / v.params.slidesPerGroup), v.snapIndex >= v.snapGrid.length && (v.snapIndex = v.snapGrid.length - 1);
                var r = -v.snapGrid[v.snapIndex];
                if (v.params.autoplay && v.autoplaying && (n || !v.params.autoplayDisableOnInteraction ? v.pauseAutoplay(a) : v.stopAutoplay()), v.updateProgress(r), v.params.normalizeSlideIndex) for (var i = 0; i < v.slidesGrid.length; i++) -Math.floor(100 * r) >= Math.floor(100 * v.slidesGrid[i]) && (e = i);
                ...
                v.animating = !1, v.setWrapperTransition(0), "undefined" == typeof e && (e = !0), v.lazy && v.lazy.onTransitionEnd(), e && (v.emit("onTransitionEnd", v), v.activeIndex !== v.previousIndex && (v.emit("onSlideChangeEnd", v), v.activeIndex > v.previousIndex ? v.emit("onSlideNextEnd", v) : v.emit("onSlidePrevEnd", v))), v.params.history && v.history && v.history.setHistory(v.params.history, v.activeIndex), v.params.hashnav && v.hashnav && v.hashnav.setHash()
                ...
                if (v.params.observeParents) for (var e = v.container.parents(), a = 0; a < e.length; a++) o(e[a]);
                o(v.container[0], {childList: !1}), o(v.wrapper[0], {attributes: !1})
                ...
                if ("object" == typeof e && e.length) {
                    for (var n = 0; n < e.length; n++) a = e[n], v.slides[a] && v.slides.eq(a).remove(), a < t && t--;
                    t = Math.max(t, 0)
                ...
                fade: {
                    setTranslate: function () {
                        for (var e = 0; e < v.slides.length; e++) {
                            var a = v.slides.eq(e), t = a[0].swiperSlideOffset, n = -t;
                    ...
                    setTranslate: function () {
                        for (var e = 0; e < v.slides.length; e++) {
                            var t = v.slides.eq(e), n = t[0].progress;
                            v.params.flip.limitRotation && (n = Math.max(Math.min(t[0].progress, 1), -1));
                            var r = t[0].swiperSlideOffset, i = -180 * n, s = i, o = 0, l = -r, p = 0;
                    ...
                    setTranslate: function () {
                        var e, t = 0;
                        v.params.cube.shadow && (v.isHorizontal() ? (e = v.wrapper.find(".swiper-cube-shadow"), 0 === e.length && (e = a('<div class="swiper-cube-shadow"></div>'), v.wrapper.append(e)), e.css({height: v.width + "px"})) : (e = v.container.find(".swiper-cube-shadow"), 0 === e.length && (e = a('<div class="swiper-cube-shadow"></div>'), v.container.append(e))));
                        for (var n = 0; n < v.slides.length; n++) {
                            var r = v.slides.eq(n), i = 90 * n, s = Math.floor(i / 360);
                            ...
                            if (o <= 1 && o > -1 && (t = 90 * n + 90 * o, v.rtl && (t = 90 * -n - 90 * o)), r.transform(c), v.params.cube.slideShadows) {
                        ...
                        if (v.wrapper.css({
                            ...
                            }), v.params.cube.shadow) if (v.isHorizontal()) e.transform("translate3d(0px, " + (v.width / 2 + v.params.cube.shadowOffset) + "px, " + -v.width / 2 + "px) rotateX(90deg) rotateZ(0deg) scale(" + v.params.cube.shadowScale + ")"); else {
                            var f = Math.abs(t) - 90 * Math.floor(Math.abs(t) / 90),
                                h = 1.5 - (Math.sin(2 * f * Math.PI / 360) / 2 + Math.cos(2 * f * Math.PI / 360) / 2),
                                g = v.params.cube.shadowScale, b = v.params.cube.shadowScale / h,
                    ...
                    setTranslate: function () {
                        for (var e = v.translate, t = v.isHorizontal() ? -e + v.width / 2 : -e + v.height / 2, n = v.isHorizontal() ? v.params.coverflow.rotate : -v.params.coverflow.rotate, r = v.params.coverflow.depth, i = 0, s = v.slides.length; i < s; i++) {
                            var o = v.slides.eq(i), l = v.slidesSizesGrid[i], p = o[0].swiperSlideOffset,
                                d = (t - p - l / 2) / l * v.params.coverflow.modifier, c = v.isHorizontal() ? n * d : 0,
                                u = v.isHorizontal() ? 0 : n * d, m = -r * Math.abs(d),
                ...
                initialImageLoaded: !1, loadImageInSlide: function (e, t) {
                    if ("undefined" != typeof e && ("undefined" == typeof t && (t = !0), 0 !== v.slides.length)) {
                        var n = v.slides.eq(e),
                            r = n.find("." + v.params.lazyLoadingClass + ":not(." + v.params.lazyStatusLoadedClass + "):not(." + v.params.lazyStatusLoadingClass + ")");
                        !n.hasClass(v.params.lazyLoadingClass) || n.hasClass(v.params.lazyStatusLoadedClass) || n.hasClass(v.params.lazyStatusLoadingClass) || (r = r.add(n[0])), 0 !== r.length && r.each(function () {
                            var e = a(this);
                            e.addClass(v.params.lazyStatusLoadingClass);
                            var r = e.attr("data-background"), i = e.attr("data-src"), s = e.attr("data-srcset"),
                                o = e.attr("data-sizes");
                            v.loadImage(e[0], i || r, s, o, !1, function () {
                                if ("undefined" != typeof v && null !== v && v) {
                                    if (r ? (e.css("background-image", 'url("' + r + '")'), e.removeAttr("data-background")) : (s && (e.attr("srcset", s), e.removeAttr("data-srcset")), o && (e.attr("sizes", o), e.removeAttr("data-sizes")), i && (e.attr("src", i), e.removeAttr("data-src"))), e.addClass(v.params.lazyStatusLoadedClass).removeClass(v.params.lazyStatusLoadingClass), n.find("." + v.params.lazyPreloaderClass + ", ." + v.params.preloaderClass).remove(), v.params.loop && t) {
                                        var a = n.attr("data-swiper-slide-index");
                                        if (n.hasClass(v.params.slideDuplicateClass)) {
                                            var l = v.wrapper.children('[data-swiper-slide-index="' + a + '"]:not(.' + v.params.slideDuplicateClass + ")");
                                            v.lazy.loadImageInSlide(l.index(), !1)
                                        } else {
                                            var p = v.wrapper.children("." + v.params.slideDuplicateClass + '[data-swiper-slide-index="' + a + '"]');
                    ...
                    var e, t = v.params.slidesPerView;
                    if ("auto" === t && (t = 0), v.lazy.initialImageLoaded || (v.lazy.initialImageLoaded = !0), v.params.watchSlidesVisibility) v.wrapper.children("." + v.params.slideVisibleClass).each(function () {
                        v.lazy.loadImageInSlide(a(this).index())
                    }); else if (t > 1) for (e = v.activeIndex; e < v.activeIndex + t; e++) v.slides[e] && v.lazy.loadImageInSlide(e); else v.lazy.loadImageInSlide(v.activeIndex);
                    if (v.params.lazyLoadingInPrevNext) if (t > 1 || v.params.lazyLoadingInPrevNextAmount && v.params.lazyLoadingInPrevNextAmount > 1) {
                        var n = v.params.lazyLoadingInPrevNextAmount, r = t,
                            i = Math.min(v.activeIndex + r + Math.max(n, r), v.slides.length),
                            s = Math.max(v.activeIndex - Math.max(r, n), 0);
                        for (e = v.activeIndex + t; e < i; e++) v.slides[e] && v.lazy.loadImageInSlide(e);
                ...
                isTouched: !1, setDragPosition: function (e) {
                    var a = v.scrollbar,
                        ...
                        r = -v.minTranslate() * a.moveDivider, i = -v.maxTranslate() * a.moveDivider;
                    n < r ? n = r : n > i && (n = i), n = -n / a.moveDivider, v.updateProgress(n), v.setWrapperTranslate(n, !0)
                    ...
                    return v.params.simulateTouch !== !1 || v.support.touch ? v.touchEvents : v.touchEventsDesktop
                    ...
                    if (v.params.scrollbar) {
                        ...
                        e = (a.trackSize - a.dragSize) * v.progress, v.rtl && v.isHorizontal() ? (e = -e, e > 0 ? (t = a.dragSize - e, e = 0) : -e + a.dragSize > a.trackSize && (t = a.trackSize + e)) : e < 0 ? (t = a.dragSize + e, e = 0) : e + a.dragSize > a.trackSize && (t = a.trackSize - e), v.isHorizontal() ? (v.support.transforms3d ? a.drag.transform("translate3d(" + e + "px, 0, 0)") : a.drag.transform("translateX(" + e + "px)"), a.drag[0].style.width = t + "px") : (v.support.transforms3d ? a.drag.transform("translate3d(0px, " + e + "px, 0)") : a.drag.transform("translateY(" + e + "px)"), a.drag[0].style.height = t + "px"), v.params.scrollbarHide && (clearTimeout(a.timeout), a.track[0].style.opacity = 1, a.timeout = setTimeout(function () {
                ...
                LinearSpline: function (e, a) {
                    ...
                    this.interpolate = function (e) {
                        return e ? (r = t(this.x, e), n = r - 1, (e - this.x[n]) * (this.y[r] - this.y[n]) / (this.x[r] - this.x[n]) + this.y[n]) : 0
                    }
                    ...
                    if (Array.isArray(r)) for (n = 0; n < r.length; n++) r[n] !== a && r[n] instanceof Swiper && t(r[n]); else r instanceof Swiper && a !== r && t(r)
                }
            }, v.parallax = {
                setTranslate: function () {
                ...
                getDistanceBetweenTouches: function (e) {
                    ...
                    var a = e.targetTouches[0].pageX, t = e.targetTouches[0].pageY, n = e.targetTouches[1].pageX,
                        r = e.targetTouches[1].pageY, i = Math.sqrt(Math.pow(n - a, 2) + Math.pow(r - t, 2));
                    return i
                },
                onGestureStart: function (e) {
                    ...
                    return t.gesture.slide && t.gesture.slide.length || (t.gesture.slide = a(this), 0 === t.gesture.slide.length && (t.gesture.slide = v.slides.eq(v.activeIndex)), t.gesture.image = t.gesture.slide.find("img, svg, canvas"), t.gesture.imageWrap = t.gesture.image.parent("." + v.params.zoomContainerClass), t.gesture.zoomMax = t.gesture.imageWrap.attr("data-swiper-zoom") || v.params.zoomMax, 0 !== t.gesture.imageWrap.length) ? (t.gesture.image.transition(0), void(t.isScaling = !0)) : void(t.gesture.image = void 0)
                },
                ...
                onTouchMove: function (e) {
                    ...
                    if (a.gesture.image && 0 !== a.gesture.image.length && (v.allowClick = !1, a.image.isTouched && a.gesture.slide)) {
                        ...
                        var t = a.image.width * a.scale, n = a.image.height * a.scale;
                        if (!(t < a.gesture.slideWidth && n < a.gesture.slideHeight)) {
                            if (a.image.minX = Math.min(a.gesture.slideWidth / 2 - t / 2, 0), a.image.maxX = -a.image.minX, a.image.minY = Math.min(a.gesture.slideHeight / 2 - n / 2, 0), a.image.maxY = -a.image.minY, a.image.touchesCurrent.x = "touchmove" === e.type ? e.targetTouches[0].pageX : e.pageX, a.image.touchesCurrent.y = "touchmove" === e.type ? e.targetTouches[0].pageY : e.pageY, !a.image.isMoved && !a.isScaling) {
                                if (v.isHorizontal() && Math.floor(a.image.minX) === Math.floor(a.image.startX) && a.image.touchesCurrent.x < a.image.touchesStart.x || Math.floor(a.image.maxX) === Math.floor(a.image.startX) && a.image.touchesCurrent.x > a.image.touchesStart.x) return void(a.image.isTouched = !1);
                                if (!v.isHorizontal() && Math.floor(a.image.minY) === Math.floor(a.image.startY) && a.image.touchesCurrent.y < a.image.touchesStart.y || Math.floor(a.image.maxY) === Math.floor(a.image.startY) && a.image.touchesCurrent.y > a.image.touchesStart.y) return void(a.image.isTouched = !1)
                            }
                ...
                onTouchEnd: function (e, a) {
                    ...
                    if (t.gesture.image && 0 !== t.gesture.image.length) {
                        ...
                        var n = 300, r = 300, i = t.velocity.x * n, s = t.image.currentX + i, o = t.velocity.y * r,
                            l = t.image.currentY + o;
                        0 !== t.velocity.x && (n = Math.abs((s - t.image.currentX) / t.velocity.x)), 0 !== t.velocity.y && (r = Math.abs((l - t.image.currentY) / t.velocity.y));
                        var p = Math.max(n, r);
                ...
                toggleZoom: function (e, t) {
                    var n = e.zoom;
                    if (n.gesture.slide || (n.gesture.slide = e.clickedSlide ? a(e.clickedSlide) : e.slides.eq(e.activeIndex), n.gesture.image = n.gesture.slide.find("img, svg, canvas"), n.gesture.imageWrap = n.gesture.image.parent("." + e.params.zoomContainerClass)), n.gesture.image && 0 !== n.gesture.image.length) {
                        var r, i, s, o, l, p, d, c, u, m, f, h, g, v, b, w, C, y;
            ...
            return v.callPlugins = function (e) {
                ...
                liveRegion: a('<span class="' + v.params.notificationClass + '" aria-live="assertive" aria-atomic="true"></span>'),
                notify: function (e) {
